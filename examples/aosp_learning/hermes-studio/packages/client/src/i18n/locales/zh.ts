export default {
  ...
  learningConsole: {
    ...
    saveConfig: '保存配置',
    configSaved: '配置已保存',
    configFetchFailed: '获取配置失败',
    configSaveFailed: '保存配置失败',
    indexControl: '索引控制',
    selectModule: '选择模块',
    start: '开始学习',
    stop: '停止学习',
    indexStarted: '已启动 {module} 模块学习',
    indexStopped: '已停止学习',
    startFailed: '启动失败',
    stopFailed: '停止失败',
    processStatus: '进程状态',
    ...
    elapsed: '已用时间',
    indexProgress: '索引进度',
    filesProcessed: '文件处理进度',
    totalFiles: '总文件数',
    inFlight: '处理中',
    added: '已入库',
    noActiveProcess: '暂无活跃进程',
    gpuStatus: 'GPU 状态',
    gpuUtil: 'GPU 利用率',
    gpuMem: '显存',
    gpuTemp: '温度',
    ...
    externalDetected: '检测到非 Web UI 启动的学习进程',
    memory: '内存',
    uptime: '运行时间',
    target: '目标',
  },
