    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('tools')" class="nav-group-items">
          ...
          <RouteLinkItem v-if="hasRoute('hermes.learning')" class="nav-item" :to="{ name: 'hermes.learning' }" :active="selectedKey === 'hermes.learning'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" />
              <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" />
            </svg>
            <span>{{ t("sidebar.learningConsole") }}</span>
          </RouteLinkItem>
        </div>
      </div>
