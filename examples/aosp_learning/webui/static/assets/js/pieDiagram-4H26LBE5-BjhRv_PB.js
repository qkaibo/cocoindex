import{xa as j}from"./index-tvYt9uZA.js";import{n as q,t as J}from"./mermaid-parser.core-5pN4YCMQ.js";import{Bt as r,H as B,Ht as D,L as tt,Vt as et,t as at,xt as it}from"./src-R1xd3Kus.js";import{U as rt,W as st,a as nt,c as ot,f as lt,j as ct,q as dt,v as pt,w as gt,x as ht,y as ut}from"./chunk-CSCIHK7Q-W6Hogs-J.js";import{n as ft,t as mt}from"./chunk-WU5MYG2G--30ohQ13.js";import{d as _t,i as xt,m as St}from"./chunk-5ZQYHXKU-Ku05N9PI.js";import{n as wt,t as Ct}from"./chunk-4BX2VUAB-C2is6i4e.js";var y,g,l,h,F,$,L,R,z,I,Dt,yt=j((()=>{mt(),Ct(),_t(),ct(),et(),J(),at(),y=lt.pie,g={sections:new Map,showData:!1,config:y},l=g.sections,h=g.showData,F=structuredClone(y),$={getConfig:r(()=>structuredClone(F),"getConfig"),clear:r(()=>{l=new Map,h=g.showData,nt()},"clear"),setDiagramTitle:dt,getDiagramTitle:gt,setAccTitle:st,getAccTitle:ut,setAccDescription:rt,getAccDescription:pt,addSection:r(({label:t,value:a})=>{if(a<0)throw new Error(`"${t}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);l.has(t)||(l.set(t,a),D.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),getSections:r(()=>l,"getSections"),setShowData:r(t=>{h=t},"setShowData"),getShowData:r(()=>h,"getShowData")},L=r((t,a)=>{wt(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),R={parse:r(async t=>{const a=await q("pie",t);D.debug(a),L(a,$)},"parse")},z=r(t=>`
  .pieCircle{
