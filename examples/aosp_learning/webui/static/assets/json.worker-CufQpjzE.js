	...
	var Do = class {
		constructor() {
			this.listeners = [], this.unexpectedErrorHandler = function(e) {
				setTimeout(() => {
					throw e.stack ? jn.isErrorNoTelemetry(e) ? new jn(e.message + `
...
` + e.stack) : e;
	...
	function qn(e) {
		if (e instanceof Error) {
			...
			return {
				...
				noTelemetry: jn.isErrorNoTelemetry(e),
				cause: r ? qn(r) : void 0,
				code: e.code
			};
		}
	...
	const $o = "Canceled";
	function Bo(e) {
		return e instanceof pi ? !0 : e instanceof Error && e.name === "Canceled" && e.message === "Canceled";
	}
	var pi = class extends Error {
		constructor() {
			super($o), this.name = this.message;
		}
	}, jn = class si extends Error {
		constructor(t) {
	...
	}, ue = class No extends Error {
		constructor(t) {
			super(t || "An unexpected bug occurred."), Object.setPrototypeOf(this, No.prototype);
		}
	};
	...
	(function(e) {
		...
		e.from = a;
		function* l(L) {
			for (let T = L.length - 1; T >= 0; T--) yield L[T];
		}
		e.reverse = l;
		function o(L) {
		...
		function h(L, T) {
			let I = 0;
			for (const D of L) if (T(D, I++)) return !0;
			return !1;
		}
		e.some = h;
		function f(L, T) {
			let I = 0;
			for (const D of L) if (!T(D, I++)) return !1;
			return !0;
		}
		e.every = f;
		function g(L, T) {
			for (const I of L) if (T(I)) return I;
		}
		e.find = g;
		function* m(L, T) {
			for (const I of L) T(I) && (yield I);
		}
		e.filter = m;
		function* d(L, T) {
			let I = 0;
			for (const D of L) yield T(D, I++);
		}
		e.map = d;
		function* p(L, T) {
			let I = 0;
		...
		e.flatMap = p;
		function* v(...L) {
			for (const T of L) Wo(T) ? yield* T : yield T;
		}
		e.concat = v;
		function S(L, T, I) {
			let D = I;
			for (const M of L) D = T(D, M);
			return D;
		}
		e.reduce = S;
		function N(L) {
		...
		e.length = N;
		function* b(L, T, I = L.length) {
			for (T < -L.length && (T = 0), T < 0 && (T += L.length), I < 0 ? I += L.length : I > L.length && (I = L.length); T < I; T++) yield L[T];
		}
		e.slice = b;
		function _(L, T = Number.POSITIVE_INFINITY) {
			const I = [];
			if (T === 0) return [I, L];
			const D = L[Symbol.iterator]();
			for (let M = 0; M < T; M++) {
				const w = D.next();
				if (w.done) return [I, e.empty()];
				I.push(w.value);
			}
		...
		async function y(L) {
			const T = [];
			for await (const I of L) T.push(I);
			return T;
		}
		e.asyncToArray = y;
		async function A(L) {
			let T = [];
			for await (const I of L) T = T.concat(I);
			return T;
		}
	...
	var an = class So {
		...
		add(t) {
			if (!t || t === ot.None) return t;
			if (t === this) throw new Error("Cannot register a disposable on itself!");
			return this._isDisposed ? So.DISABLE_DISPOSED_WARNING || console.warn((/* @__PURE__ */ new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!")).stack) : this._toDispose.add(t), t;
		}
		delete(t) {
			if (t) {
	...
	yi = an, yi.DISABLE_DISPOSED_WARNING = !1;
	var ot = class {
		constructor() {
	...
	vi = ot, vi.None = Object.freeze({ dispose() {} });
	var Wn, Z = class ai {
		constructor(t) {
			this.element = t, this.next = ai.Undefined, this.prev = ai.Undefined;
		}
	};
	Wn = Z, Wn.Undefined = new Wn(void 0);
	var Go = class {
		constructor() {
	...
	const Jo = globalThis.performance.now.bind(globalThis.performance);
	var _i = class Ao {
		static create(t) {
			return new Ao(t);
		}
		constructor(t) {
			this._now = t === !1 ? Date.now : Jo, this._startTime = this._now(), this._stopTime = -1;
		}
		stop() {
	...
	(function(e) {
		e.None = () => ot.None;
		function t(w, R) {
			return g(w, () => {}, 0, void 0, !0, void 0, R);
		}
		e.defer = t;
		function n(w) {
			return (R, P = null, C) => {
		...
		e.once = n;
		function r(w, R) {
			return e.once(e.filter(w, R));
		}
		e.onceIf = r;
		function i(w, R, P) {
			return h((C, F = null, V) => w((j) => C.call(F, R(j)), null, V), P);
		}
		e.map = i;
		function s(w, R, P) {
			return h((C, F = null, V) => w((j) => {
				R(j), C.call(F, j);
			}, null, V), P);
		}
		e.forEach = s;
		function a(w, R, P) {
			return h((C, F = null, V) => w((j) => R(j) && C.call(F, j), null, V), P);
		}
		e.filter = a;
		function l(w) {
			return w;
		...
		e.signal = l;
		function o(...w) {
			return (R, P = null, C) => f(Ho(...w.map((F) => F((V) => R.call(P, V)))), C);
		}
		e.any = o;
		function u(w, R, P, C) {
			let F = P;
			return i(w, (V) => (F = R(F, V), F), C);
		}
		e.reduce = u;
		function h(w, R) {
			let P;
		...
		function f(w, R) {
			return R instanceof Array ? R.push(w) : R && R.add(w), w;
		}
		function g(w, R, P = 100, C = !1, F = !1, V, j) {
			let G, W, _e, Vn = 0, Qt;
			const Dn = new Me({
				leakWarningThreshold: V,
				onWillAddFirstListener() {
					G = w((t2) => {
						Vn++, W = R(W, t2), C && !_e && (Dn.fire(W), W = void 0), Qt = () => {
							const n2 = W;
							W = void 0, _e = void 0, (!C || Vn > 1) && Dn.fire(n2), Vn = 0;
						}, typeof P == "number" ? (_e && clearTimeout(_e), _e = setTimeout(Qt, P)) : _e === void 0 && (_e = null, queueMicrotask(Qt));
					});
				},
			...
			return j?.add(Dn), Dn.event;
		}
		e.debounce = g;
		function m(w, R = 0, P) {
			return e.debounce(w, (C, F) => C ? (C.push(F), C) : [F], R, void 0, !0, void 0, P);
		}
		e.accumulate = m;
		function d(w, R = (C, F) => C === F, P) {
			let C = !0, F;
			return a(w, (V) => {
				const j = C || !R(V, F);
				return C = !1, F = V, j;
		...
		e.latch = d;
		function p(w, R, P) {
			return [e.filter(w, R, P), e.filter(w, (C) => !R(C), P)];
		}
		e.split = p;
		function v(w, R = !1, P = [], C) {
			let F = P.slice(), V = w((W) => {
				F ? F.push(W) : G.fire(W);
			});
			C && C.add(V);
		...
		function _(w, R, P = (C) => C) {
			const C = (...G) => j.fire(P(...G)), F = () => w.on(R, C), V = () => w.removeListener(R, C), j = new Me({
		...
		function y(w, R, P = (C) => C) {
			const C = (...G) => j.fire(P(...G)), F = () => w.addEventListener(R, C), V = () => w.removeEventListener(R, C), j = new Me({
				onWillAddFirstListener: F,
				onDidRemoveLastListener: V
			});
			return j.event;
		...
		class I {
			constructor(R, P) {
				...
				this.emitter = new Me(C), P && P.add(this.emitter);
			}
			beginUpdate(R) {
				this._counter++;
			}
		...
		function D(w, R) {
			return new I(w, R).emitter.event;
		}
		e.fromObservable = D;
		function M(w) {
			return (R, P, C) => {
				...
				const j = {
					...
					endUpdate() {
						F--, F === 0 && (w.reportChanges(), V && (V = !1, R.call(P)));
					},
				...
				w.addObserver(j), w.reportChanges();
				const G = { dispose() {
					w.removeObserver(j);
				} };
				return C instanceof an ? C.add(G) : Array.isArray(C) && C.push(G), G;
			};
		}
	...
	var Ni = class oi {
		constructor(t) {
			this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${t}_${oi._idPool++}`, oi.all.add(this);
		}
		start(t) {
			this._stopWatch = new _i(), this.listenerCount = t;
		}
		stop() {
			if (this._stopWatch) {
	...
	Hn = Ni, Hn.all = /* @__PURE__ */ new Set(), Hn._idPool = 0;
	let Xo = -1;
	var Si = class ko {
		constructor(t, n, r = (ko._idPool++).toString(16).padStart(3, "0")) {
...
`));
	...
	var Me = class {
		constructor(e) {
			this._size = 0, this._options = e, this._leakageMon = this._options?.leakWarningThreshold ? new Si(e?.onListenerError ?? tn, this._options?.leakWarningThreshold ?? Xo) : void 0, this._perfMon = this._options?._profName ? new Ni(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
		}
		dispose() {
		...
		get event() {
			return this._event ?? (this._event = (e, t, n) => {
				if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
					...
					console.warn(a);
					const l = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], o = new Yo(`${a}. HINT: Stack shows most frequent listener (${l[1]}-times)`, l[0]);
					return (this._options?.onListenerError || tn)(o), ot.None;
				}
				if (this._disposed) return ot.None;
				t && (e = e.bind(t));
				const r = new Gn(e);
				let i;
				this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * .2) && (r.stack = Qo.create(), i = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof Gn ? (this._deliveryQueue ?? (this._deliveryQueue = new el()), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
				const s = sn(() => {
					i?.(), this._removeListener(r);
				});
				return n instanceof an ? n.add(s) : Array.isArray(n) && n.push(s), s;
			}), this._event;
		}
		_removeListener(e) {
		...
		fire(e) {
			if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof Gn) this._deliver(this._listeners, e);
			else {
	...
	const nl = Ai() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
	function ki(e, t) {
		let n;
		...
		}), nl && (n = "［" + n.replace(/[aouei]/g, "$&$&") + "］"), n;
	}
	function $(e, t, ...n) {
		return ki(typeof e == "number" ? rl(e, t) : t, n);
	}
	function rl(e, t) {
		const n = tl()?.[e];
		if (typeof n != "string") {
	...
	let on = !1, ln = !1, un = !1, xi = !1, Ie;
	const Fe = globalThis;
	let fe;
	typeof Fe.vscode < "u" && typeof Fe.vscode.process < "u" ? fe = Fe.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (fe = process);
	const ol = typeof fe?.versions?.electron == "string" && fe?.type === "renderer";
	if (typeof fe == "object") {
		on = fe.platform === "win32", ln = fe.platform === "darwin", un = fe.platform === "linux", un && fe.env.SNAP && fe.env.SNAP_REVISION, fe.env.CI || fe.env.BUILD_ARTIFACTSTAGINGDIRECTORY || fe.env.GITHUB_WORKSPACE;
		const e = fe.env.VSCODE_NLS_CONFIG;
		if (e) try {
			const t = JSON.parse(e);
			t.userLocale, t.osLocale, t.resolvedLanguage, t.languagePack?.translationsConfigFile;
		} catch {}
	} else typeof navigator == "object" && !ol ? (Ie = navigator.userAgent, on = Ie.indexOf("Windows") >= 0, ln = Ie.indexOf("Macintosh") >= 0, (Ie.indexOf("Macintosh") >= 0 || Ie.indexOf("iPad") >= 0 || Ie.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints, un = Ie.indexOf("Linux") >= 0, Ie?.indexOf("Mobi"), xi = !0, Ai(), navigator.language.toLowerCase()) : console.error("Unable to resolve platform.");
	const Et = on, ll = ln;
	xi && typeof Fe.importScripts == "function" && Fe.origin;
	const Ee = Ie, ul = typeof Fe.postMessage == "function" && !Fe.importScripts;
	(() => {
		if (ul) {
			const e = [];
	...
	const fl = !!(Ee && Ee.indexOf("Chrome") >= 0);
	Ee && Ee.indexOf("Firefox");
	!fl && Ee && Ee.indexOf("Safari");
	Ee && Ee.indexOf("Edg/");
	...
	var ml = class {
		constructor(e, t) {
			this.lastCache = void 0, this.lastArgKey = void 0, typeof e == "function" ? (this._fn = e, this._computeKey = hl) : (this._fn = t, this._computeKey = e.getCacheKey);
		}
		get(e) {
	...
	var Qn = class {
		constructor(e) {
			this.executor = e, this._state = Xe.Uninitialized;
		}
		get value() {
			if (this._state === Xe.Uninitialized) {
				this._state = Xe.Running;
				try {
					this._value = this.executor();
				} catch (e) {
					this._error = e;
				} finally {
					this._state = Xe.Completed;
				}
			} else if (this._state === Xe.Running) throw new Error("Cannot read the value of a lazy that is being initialized");
	...
	var fn = class li {
		static getInstance(t) {
			return li.cache.get(Array.from(t));
		}
		static getLocales() {
			return li._locales.value;
		}
		constructor(t) {
	...
	Qe = fn, Qe.ambiguousCharacterData = new Qn(() => JSON.parse("{\"_common\":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,1523,96,8242,96,1370,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022,92,12034,92,42872,38,708,94,710,94,5869,43,10133,43,66203,43,8249,60,10094,60,706,60,119350,60,5176,60,5810,60,5120,61,11840,61,12448,61,42239,61,8250,62,10095,62,707,62,119351,62,5171,62,94015,62,8275,126,732,126,8128,126,8764,126,65372,124,65293,45,118002,50,120784,50,120794,50,120804,50,120814,50,120824,50,130034,50,42842,50,423,50,1000,50,42564,50,5311,50,42735,50,119302,51,118003,51,120785,51,120795,51,120805,51,120815,51,120825,51,130035,51,42923,51,540,51,439,51,42858,51,11468,51,1248,51,94011,51,71882,51,118004,52,120786,52,120796,52,120806,52,120816,52,120826,52,130036,52,5070,52,71855,52,118005,53,120787,53,120797,53,120807,53,120817,53,120827,53,130037,53,444,53,71867,53,118006,54,120788,54,120798,54,120808,54,120818,54,120828,54,130038,54,11474,54,5102,54,71893,54,119314,55,118007,55,120789,55,120799,55,120809,55,120819,55,120829,55,130039,55,66770,55,71878,55,2819,56,2538,56,2666,56,125131,56,118008,56,120790,56,120800,56,120810,56,120820,56,120830,56,130040,56,547,56,546,56,66330,56,2663,57,2920,57,2541,57,3437,57,118009,57,120791,57,120801,57,120811,57,120821,57,120831,57,130041,57,42862,57,11466,57,71884,57,71852,57,71894,57,9082,97,65345,97,119834,97,119886,97,119938,97,119990,97,120042,97,120094,97,120146,97,120198,97,120250,97,120302,97,120354,97,120406,97,120458,97,593,97,945,97,120514,97,120572,97,120630,97,120688,97,120746,97,65313,65,117974,65,119808,65,119860,65,119912,65,119964,65,120016,65,120068,65,120120,65,120172,65,120224,65,120276,65,120328,65,120380,65,120432,65,913,65,120488,65,120546,65,120604,65,120662,65,120720,65,5034,65,5573,65,42222,65,94016,65,66208,65,119835,98,119887,98,119939,98,119991,98,120043,98,120095,98,120147,98,120199,98,120251,98,120303,98,120355,98,120407,98,120459,98,388,98,5071,98,5234,98,5551,98,65314,66,8492,66,117975,66,119809,66,119861,66,119913,66,120017,66,120069,66,120121,66,120173,66,120225,66,120277,66,120329,66,120381,66,120433,66,42932,66,914,66,120489,66,120547,66,120605,66,120663,66,120721,66,5108,66,5623,66,42192,66,66178,66,66209,66,66305,66,65347,99,8573,99,119836,99,119888,99,119940,99,119992,99,120044,99,120096,99,120148,99,120200,99,120252,99,120304,99,120356,99,120408,99,120460,99,7428,99,1010,99,11429,99,43951,99,66621,99,128844,67,71913,67,71922,67,65315,67,8557,67,8450,67,8493,67,117976,67,119810,67,119862,67,119914,67,119966,67,120018,67,120174,67,120226,67,120278,67,120330,67,120382,67,120434,67,1017,67,11428,67,5087,67,42202,67,66210,67,66306,67,66581,67,66844,67,8574,100,8518,100,119837,100,119889,100,119941,100,119993,100,120045,100,120097,100,120149,100,120201,100,120253,100,120305,100,120357,100,120409,100,120461,100,1281,100,5095,100,5231,100,42194,100,8558,68,8517,68,117977,68,119811,68,119863,68,119915,68,119967,68,120019,68,120071,68,120123,68,120175,68,120227,68,120279,68,120331,68,120383,68,120435,68,5024,68,5598,68,5610,68,42195,68,8494,101,65349,101,8495,101,8519,101,119838,101,119890,101,119942,101,120046,101,120098,101,120150,101,120202,101,120254,101,120306,101,120358,101,120410,101,120462,101,43826,101,1213,101,8959,69,65317,69,8496,69,117978,69,119812,69,119864,69,119916,69,120020,69,120072,69,120124,69,120176,69,120228,69,120280,69,120332,69,120384,69,120436,69,917,69,120492,69,120550,69,120608,69,120666,69,120724,69,11577,69,5036,69,42224,69,71846,69,71854,69,66182,69,119839,102,119891,102,119943,102,119995,102,120047,102,120099,102,120151,102,120203,102,120255,102,120307,102,120359,102,120411,102,120463,102,43829,102,42905,102,383,102,7837,102,1412,102,119315,70,8497,70,117979,70,119813,70,119865,70,119917,70,120021,70,120073,70,120125,70,120177,70,120229,70,120281,70,120333,70,120385,70,120437,70,42904,70,988,70,120778,70,5556,70,42205,70,71874,70,71842,70,66183,70,66213,70,66853,70,65351,103,8458,103,119840,103,119892,103,119944,103,120048,103,120100,103,120152,103,120204,103,120256,103,120308,103,120360,103,120412,103,120464,103,609,103,7555,103,397,103,1409,103,117980,71,119814,71,119866,71,119918,71,119970,71,120022,71,120074,71,120126,71,120178,71,120230,71,120282,71,120334,71,120386,71,120438,71,1292,71,5056,71,5107,71,42198,71,65352,104,8462,104,119841,104,119945,104,119997,104,120049,104,120101,104,120153,104,120205,104,120257,104,120309,104,120361,104,120413,104,120465,104,1211,104,1392,104,5058,104,65320,72,8459,72,8460,72,8461,72,117981,72,119815,72,119867,72,119919,72,120023,72,120179,72,120231,72,120283,72,120335,72,120387,72,120439,72,919,72,120494,72,120552,72,120610,72,120668,72,120726,72,11406,72,5051,72,5500,72,42215,72,66255,72,731,105,9075,105,65353,105,8560,105,8505,105,8520,105,119842,105,119894,105,119946,105,119998,105,120050,105,120102,105,120154,105,120206,105,120258,105,120310,105,120362,105,120414,105,120466,105,120484,105,618,105,617,105,953,105,8126,105,890,105,120522,105,120580,105,120638,105,120696,105,120754,105,1110,105,42567,105,1231,105,43893,105,5029,105,71875,105,65354,106,8521,106,119843,106,119895,106,119947,106,119999,106,120051,106,120103,106,120155,106,120207,106,120259,106,120311,106,120363,106,120415,106,120467,106,1011,106,1112,106,65322,74,117983,74,119817,74,119869,74,119921,74,119973,74,120025,74,120077,74,120129,74,120181,74,120233,74,120285,74,120337,74,120389,74,120441,74,42930,74,895,74,1032,74,5035,74,5261,74,42201,74,119844,107,119896,107,119948,107,120000,107,120052,107,120104,107,120156,107,120208,107,120260,107,120312,107,120364,107,120416,107,120468,107,8490,75,65323,75,117984,75,119818,75,119870,75,119922,75,119974,75,120026,75,120078,75,120130,75,120182,75,120234,75,120286,75,120338,75,120390,75,120442,75,922,75,120497,75,120555,75,120613,75,120671,75,120729,75,11412,75,5094,75,5845,75,42199,75,66840,75,1472,108,8739,73,9213,73,65512,73,1633,108,1777,73,66336,108,125127,108,118001,108,120783,73,120793,73,120803,73,120813,73,120823,73,130033,73,65321,73,8544,73,8464,73,8465,73,117982,108,119816,73,119868,73,119920,73,120024,73,120128,73,120180,73,120232,73,120284,73,120336,73,120388,73,120440,73,65356,108,8572,73,8467,108,119845,108,119897,108,119949,108,120001,108,120053,108,120105,73,120157,73,120209,73,120261,73,120313,73,120365,73,120417,73,120469,73,448,73,120496,73,120554,73,120612,73,120670,73,120728,73,11410,73,1030,73,1216,73,1493,108,1503,108,1575,108,126464,108,126592,108,65166,108,65165,108,1994,108,11599,73,5825,73,42226,73,93992,73,66186,124,66313,124,119338,76,8556,76,8466,76,117985,76,119819,76,119871,76,119923,76,120027,76,120079,76,120131,76,120183,76,120235,76,120287,76,120339,76,120391,76,120443,76,11472,76,5086,76,5290,76,42209,76,93974,76,71843,76,71858,76,66587,76,66854,76,65325,77,8559,77,8499,77,117986,77,119820,77,119872,77,119924,77,120028,77,120080,77,120132,77,120184,77,120236,77,120288,77,120340,77,120392,77,120444,77,924,77,120499,77,120557,77,120615,77,120673,77,120731,77,1018,77,11416,77,5047,77,5616,77,5846,77,42207,77,66224,77,66321,77,119847,110,119899,110,119951,110,120003,110,120055,110,120107,110,120159,110,120211,110,120263,110,120315,110,120367,110,120419,110,120471,110,1400,110,1404,110,65326,78,8469,78,117987,78,119821,78,119873,78,119925,78,119977,78,120029,78,120081,78,120185,78,120237,78,120289,78,120341,78,120393,78,120445,78,925,78,120500,78,120558,78,120616,78,120674,78,120732,78,11418,78,42208,78,66835,78,3074,111,3202,111,3330,111,3458,111,2406,111,2662,111,2790,111,3046,111,3174,111,3302,111,3430,111,3664,111,3792,111,4160,111,1637,111,1781,111,65359,111,8500,111,119848,111,119900,111,119952,111,120056,111,120108,111,120160,111,120212,111,120264,111,120316,111,120368,111,120420,111,120472,111,7439,111,7441,111,43837,111,959,111,120528,111,120586,111,120644,111,120702,111,120760,111,963,111,120532,111,120590,111,120648,111,120706,111,120764,111,11423,111,4351,111,1413,111,1505,111,1607,111,126500,111,126564,111,126596,111,65259,111,65260,111,65258,111,65257,111,1726,111,64428,111,64429,111,64427,111,64426,111,1729,111,64424,111,64425,111,64423,111,64422,111,1749,111,3360,111,4125,111,66794,111,71880,111,71895,111,66604,111,1984,79,2534,79,2918,79,12295,79,70864,79,71904,79,118000,79,120782,79,120792,79,120802,79,120812,79,120822,79,130032,79,65327,79,117988,79,119822,79,119874,79,119926,79,119978,79,120030,79,120082,79,120134,79,120186,79,120238,79,120290,79,120342,79,120394,79,120446,79,927,79,120502,79,120560,79,120618,79,120676,79,120734,79,11422,79,1365,79,11604,79,4816,79,2848,79,66754,79,42227,79,71861,79,66194,79,66219,79,66564,79,66838,79,9076,112,65360,112,119849,112,119901,112,119953,112,120005,112,120057,112,120109,112,120161,112,120213,112,120265,112,120317,112,120369,112,120421,112,120473,112,961,112,120530,112,120544,112,120588,112,120602,112,120646,112,120660,112,120704,112,120718,112,120762,112,120776,112,11427,112,65328,80,8473,80,117989,80,119823,80,119875,80,119927,80,119979,80,120031,80,120083,80,120187,80,120239,80,120291,80,120343,80,120395,80,120447,80,929,80,120504,80,120562,80,120620,80,120678,80,120736,80,11426,80,5090,80,5229,80,42193,80,66197,80,119850,113,119902,113,119954,113,120006,113,120058,113,120110,113,120162,113,120214,113,120266,113,120318,113,120370,113,120422,113,120474,113,1307,113,1379,113,1382,113,8474,81,117990,81,119824,81,119876,81,119928,81,119980,81,120032,81,120084,81,120188,81,120240,81,120292,81,120344,81,120396,81,120448,81,11605,81,119851,114,119903,114,119955,114,120007,114,120059,114,120111,114,120163,114,120215,114,120267,114,120319,114,120371,114,120423,114,120475,114,43847,114,43848,114,7462,114,11397,114,43905,114,119318,82,8475,82,8476,82,8477,82,117991,82,119825,82,119877,82,119929,82,120033,82,120189,82,120241,82,120293,82,120345,82,120397,82,120449,82,422,82,5025,82,5074,82,66740,82,5511,82,42211,82,94005,82,65363,115,119852,115,119904,115,119956,115,120008,115,120060,115,120112,115,120164,115,120216,115,120268,115,120320,115,120372,115,120424,115,120476,115,42801,115,445,115,1109,115,43946,115,71873,115,66632,115,65331,83,117992,83,119826,83,119878,83,119930,83,119982,83,120034,83,120086,83,120138,83,120190,83,120242,83,120294,83,120346,83,120398,83,120450,83,1029,83,1359,83,5077,83,5082,83,42210,83,94010,83,66198,83,66592,83,119853,116,119905,116,119957,116,120009,116,120061,116,120113,116,120165,116,120217,116,120269,116,120321,116,120373,116,120425,116,120477,116,8868,84,10201,84,128872,84,65332,84,117993,84,119827,84,119879,84,119931,84,119983,84,120035,84,120087,84,120139,84,120191,84,120243,84,120295,84,120347,84,120399,84,120451,84,932,84,120507,84,120565,84,120623,84,120681,84,120739,84,11430,84,5026,84,42196,84,93962,84,71868,84,66199,84,66225,84,66325,84,119854,117,119906,117,119958,117,120010,117,120062,117,120114,117,120166,117,120218,117,120270,117,120322,117,120374,117,120426,117,120478,117,42911,117,7452,117,43854,117,43858,117,651,117,965,117,120534,117,120592,117,120650,117,120708,117,120766,117,1405,117,66806,117,71896,117,8746,85,8899,85,117994,85,119828,85,119880,85,119932,85,119984,85,120036,85,120088,85,120140,85,120192,85,120244,85,120296,85,120348,85,120400,85,120452,85,1357,85,4608,85,66766,85,5196,85,42228,85,94018,85,71864,85,8744,118,8897,118,65366,118,8564,118,119855,118,119907,118,119959,118,120011,118,120063,118,120115,118,120167,118,120219,118,120271,118,120323,118,120375,118,120427,118,120479,118,7456,118,957,118,120526,118,120584,118,120642,118,120700,118,120758,118,1141,118,1496,118,71430,118,43945,118,71872,118,119309,86,1639,86,1783,86,8548,86,117995,86,119829,86,119881,86,119933,86,119985,86,120037,86,120089,86,120141,86,120193,86,120245,86,120297,86,120349,86,120401,86,120453,86,1140,86,11576,86,5081,86,5167,86,42719,86,42214,86,93960,86,71840,86,66845,86,623,119,119856,119,119908,119,119960,119,120012,119,120064,119,120116,119,120168,119,120220,119,120272,119,120324,119,120376,119,120428,119,120480,119,7457,119,1121,119,1309,119,1377,119,71434,119,71438,119,71439,119,43907,119,71910,87,71919,87,117996,87,119830,87,119882,87,119934,87,119986,87,120038,87,120090,87,120142,87,120194,87,120246,87,120298,87,120350,87,120402,87,120454,87,1308,87,5043,87,5076,87,42218,87,5742,120,10539,120,10540,120,10799,120,65368,120,8569,120,119857,120,119909,120,119961,120,120013,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,117997,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,117998,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,71909,90,66293,90,65338,90,8484,90,8488,90,117999,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65283,35,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],\"_default\":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],\"cs\":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],\"de\":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],\"es\":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],\"fr\":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],\"it\":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],\"ja\":[8211,45,8218,44,65281,33,8216,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65292,44,65297,49,65307,59],\"ko\":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],\"pl\":[65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],\"pt-BR\":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],\"qps-ploc\":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],\"ru\":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],\"tr\":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],\"zh-hans\":[160,32,65374,126,8218,44,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65297,49],\"zh-hant\":[8211,45,65374,126,8218,44,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89]}")), Qe.cache = new ml({ getCacheKey: JSON.stringify }, (e) => {
		...
		const i = Qe.ambiguousCharacterData.value;
		let s = e.filter((o) => !o.startsWith("_") && Object.hasOwn(i, o));
		...
		const l = n(t(i._common), a);
		return new Qe(l);
	}), Qe._locales = new Qn(() => Object.keys(Qe.ambiguousCharacterData.value).filter((e) => !e.startsWith("_")));
	var hn = class On {
		static getRawData() {
	...
	Mi = hn, Mi._data = void 0;
	const Yn = "default", kl = "$initialize";
	var xl = class {
		...
		async sendMessage(e, t, n) {
			...
			return new Promise((i, s) => {
				this._pendingReplies[r] = {
					resolve: i,
					reject: s
				}, this._send(new xl(this._workerId, r, e, t, n));
			});
		}
		listen(e, t, n) {
			let r = null;
			const i = new Me({
				...
				onDidRemoveLastListener: () => {
					this._pendingEmitters.delete(r), this._send(new El(this._workerId, r)), r = null;
				}
			});
			return i.event;
		}
		...
		createProxyToRemoteChannel(e, t) {
			return new Proxy(Object.create(null), { get: (n, r) => (typeof r == "string" && !n[r] && (Ii(r) ? n[r] = (i) => this.listen(e, r, i) : Ci(r) ? n[r] = this.listen(e, r, void 0) : r.charCodeAt(0) === 36 && (n[r] = async (...i) => (await t?.(), this.sendMessage(e, r, i)))), n[r]) });
		}
		_handleMessage(e) {
			switch (e.type) {
		...
		_handleRequestMessage(e) {
			...
			this._handler.handleMessage(e.channel, e.method, e.args).then((n) => {
				this._send(new Pi(this._workerId, t, n, void 0));
			}, (n) => {
				n.detail instanceof Error && (n.detail = qn(n.detail)), this._send(new Pi(this._workerId, t, void 0, qn(n)));
			});
		}
	...
	function Ci(e) {
		return e[0] === "o" && e[1] === "n" && Ei(e.charCodeAt(2));
	}
	function Ii(e) {
		return /^onDynamic/.test(e) && Ei(e.charCodeAt(9));
	}
	var Pl = class {
		constructor(e, t) {
			this._localChannels = /* @__PURE__ */ new Map(), this._remoteChannels = /* @__PURE__ */ new Map(), this._protocol = new Tl({
				sendMessage: (n, r) => {
					e(n, r);
				},
		...
		_handleMessage(e, t, n) {
			if (e === Yn && t === kl) return this.initialize(n[0]);
			const r = e === Yn ? this.requestHandler : this._localChannels.get(e);
	...
	const Vi = typeof Buffer < "u";
	new Qn(() => new Uint8Array(256));
	let Kn;
	var Il = class Ro {
		static wrap(t) {
			return Vi && !Buffer.isBuffer(t) && (t = Buffer.from(t.buffer, t.byteOffset, t.byteLength)), new Ro(t);
		}
		constructor(t) {
			this.buffer = t, this.byteLength = this.buffer.byteLength;
		}
		toString() {
			return Vi ? this.buffer.toString() : (Kn || (Kn = new TextDecoder()), Kn.decode(this.buffer));
		}
	};
	...
	Oi = class Mo {
		...
		_step() {
			...
			for (let f = 64; f < 320; f += 4) t.setUint32(f, er(t.getUint32(f - 12, !1) ^ t.getUint32(f - 32, !1) ^ t.getUint32(f - 56, !1) ^ t.getUint32(f - 64, !1), 1), !1);
			let r = this._h0, i = this._h1, s = this._h2, a = this._h3, l = this._h4, o, u, h;
			for (let f = 0; f < 80; f++) f < 20 ? (o = i & s | ~i & a, u = 1518500249) : f < 40 ? (o = i ^ s ^ a, u = 1859775393) : f < 60 ? (o = i & s | i & a | s & a, u = 2400959708) : (o = i ^ s ^ a, u = 3395469782), h = er(r, 5) + o + l + u + t.getUint32(f * 4, !1) & 4294967295, l = a, a = s, s = er(i, 30), i = r, r = h;
	...
	}, Oi._bigBlock32 = /* @__PURE__ */ new DataView(/* @__PURE__ */ new ArrayBuffer(320));
	var Bi = class {
		constructor(e) {
			this.source = e;
		}
	...
	function Ol(e, t, n) {
		return new qi(new Bi(e), new Bi(t)).ComputeDiff(n).changes;
	}
	var lt = class {
		static Assert(e, t) {
		...
		constructor(t, n, r = null) {
			...
			const [i, s, a] = xt._getElements(t), [l, o, u] = xt._getElements(n);
		...
		ElementsAreStrictEqual(t, n) {
			return this.ElementsAreEqual(t, n) ? xt._getStrictElement(this._originalSequence, t) === xt._getStrictElement(this._modifiedSequence, n) : !1;
		}
		...
		ComputeDiffRecursive(t, n, r, i, s) {
			...
			if (t > n || r > i) {
				let f;
				return r <= i ? (lt.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), f = [new Ue(t, 0, r, i - r + 1)]) : t <= n ? (lt.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), f = [new Ue(t, n - t + 1, r, 0)]) : (lt.Assert(t === n + 1, "originalStart should only be one more than originalEnd"), lt.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), f = []), f;
			}
		...
		WALKTRACE(t, n, r, i, s, a, l, o, u, h, f, g, m, d, p, v, S, N) {
			let b = null, _ = null, y = new Ui(), A = n, L = r, T = m[0] - v[0] - i, I = -1073741824, D = this.m_forwardHistory.length - 1;
			do {
				const M = T + t;
				M === A || M < L && u[M - 1] < u[M + 1] ? (f = u[M + 1], d = f - T - i, f < I && y.MarkNextChange(), I = f, y.AddModifiedElement(f + 1, d), T = M + 1 - t) : (f = u[M - 1] + 1, d = f - T - i, f < I && y.MarkNextChange(), I = f - 1, y.AddOriginalElement(f, d + 1), T = M - 1 - t), D >= 0 && (u = this.m_forwardHistory[D], t = u[0], A = 1, L = u.length - 1);
			} while (--D >= -1);
			if (b = y.getReverseChanges(), N[0]) {
				let M = m[0] + 1, w = v[0] + 1;
				if (b !== null && b.length > 0) {
					const R = b[b.length - 1];
					M = Math.max(M, R.getOriginalEnd()), w = Math.max(w, R.getModifiedEnd());
				}
				_ = [new Ue(M, g - M + 1, w, p - w + 1)];
			} else {
				y = new Ui(), A = a, L = l, T = m[0] - v[0] - o, I = 1073741824, D = S ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
				do {
					const M = T + s;
					M === A || M < L && h[M - 1] >= h[M + 1] ? (f = h[M + 1] - 1, d = f - T - o, f > I && y.MarkNextChange(), I = f + 1, y.AddOriginalElement(f + 1, d + 1), T = M + 1 - s) : (f = h[M - 1], d = f - T - o, f > I && y.MarkNextChange(), I = f, y.AddModifiedElement(f + 1, d + 1), T = M - 1 - s), D >= 0 && (h = this.m_reverseHistory[D], s = h[0], A = 1, L = h.length - 1);
				} while (--D >= -1);
				_ = y.getChanges();
			}
		...
		ComputeRecursionPoint(t, n, r, i, s, a, l) {
			...
			const d = n - t + (i - r), p = d + 1, v = new Int32Array(p), S = new Int32Array(p), N = i - r, b = n - t, _ = t - r, y = n - i, A = (b - N) % 2 === 0;
			v[N] = t, S[b] = n, l[0] = !1;
			for (let L = 1; L <= d / 2 + 1; L++) {
				let T = 0, I = 0;
				h = this.ClipDiagonalBound(N - L, L, N, p), f = this.ClipDiagonalBound(N + L, L, N, p);
				for (let M = h; M <= f; M += 2) {
					M === h || M < f && v[M - 1] < v[M + 1] ? o = v[M + 1] : o = v[M - 1] + 1, u = o - (M - N) - _;
					const w = o;
					for (; o < n && u < i && this.ElementsAreEqual(o + 1, u + 1);) o++, u++;
					if (v[M] = o, o + u > T + I && (T = o, I = u), !A && Math.abs(M - b) <= L - 1 && o >= S[M]) return s[0] = o, a[0] = u, w <= S[M] && L <= 1448 ? this.WALKTRACE(N, h, f, _, b, g, m, y, v, S, o, n, s, u, i, a, A, l) : null;
				}
				const D = (T - t + (I - r) - L) / 2;
				if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(T, D)) return l[0] = !0, s[0] = T, a[0] = I, D > 0 && L <= 1448 ? this.WALKTRACE(N, h, f, _, b, g, m, y, v, S, o, n, s, u, i, a, A, l) : (t++, r++, [new Ue(t, n - t + 1, r, i - r + 1)]);
				...
				for (let M = g; M <= m; M += 2) {
					...
					if (S[M] = o, A && Math.abs(M - N) <= L && o <= v[M]) return s[0] = o, a[0] = u, w >= v[M] && L <= 1448 ? this.WALKTRACE(N, h, f, _, b, g, m, y, v, S, o, n, s, u, i, a, A, l) : null;
				}
				if (L <= 1447) {
					let M = new Int32Array(f - h + 2);
					M[0] = N - h + 1, ut.Copy2(v, h, M, 1, f - h + 1), this.m_forwardHistory.push(M), M = new Int32Array(m - g + 2), M[0] = b - g + 1, ut.Copy2(S, g, M, 1, m - g + 1), this.m_reverseHistory.push(M);
				}
			}
			return this.WALKTRACE(N, h, f, _, b, g, m, y, v, S, o, n, s, u, i, a, A, l);
		}
		PrettifyChanges(t) {
		...
		ConcatenateChanges(t, n) {
			...
			if (this.ChangesOverlap(t[t.length - 1], n[0], r)) {
				...
				return ut.Copy(t, 0, i, 0, t.length - 1), i[t.length - 1] = r[0], ut.Copy(n, 1, i, t.length, n.length - 1), i;
			} else {
				const i = new Array(t.length + n.length);
				return ut.Copy(t, 0, i, 0, t.length), ut.Copy(n, 0, i, t.length, n.length), i;
			}
		}
		ChangesOverlap(t, n, r) {
			if (lt.Assert(t.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), lt.Assert(t.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= n.originalStart || t.modifiedStart + t.modifiedLength >= n.modifiedStart) {
	...
	function jl() {
		if (Pt === null) {
			Pt = new $l(0);
			const e = ` 	<>'"、。｡､，．：；‘〈「『〔（［｛｢｣｝］）〕』」〉’｀～…|`;
			for (let n = 0; n < 36; n++) Pt.set(e.charCodeAt(n), 1);
			const t = ".,;:";
			for (let n = 0; n < 4; n++) Pt.set(t.charCodeAt(n), 2);
		}
		return Pt;
	}
	var Wl = class ui {
			...
			for (let s = 1, a = t.getLineCount(); s <= a; s++) {
				...
				for (; u < o;) {
					...
					if (g === 13) {
						...
						b === 1 && (i.push(ui._createLink(r, l, s, h, u)), S = !0);
					} else if (g === 12) {
						let b;
				...
				g === 13 && i.push(ui._createLink(r, l, s, h, o));
			}
			return i;
		}
	};
	...
	var nr, Wi = class {
		...
		navigateValueSet(e, t, n, r, i) {
			if (e && t) {
				const s = this.doNavigateValueSet(t, i);
				if (s) return {
					range: e,
					value: s
				};
			...
			if (n && r) {
				const s = this.doNavigateValueSet(r, i);
				if (s) return {
					range: n,
					value: s
				};
		...
		doNavigateValueSet(e, t) {
			...
			return n !== null ? n : this.textReplace(e, t);
		}
		numberReplace(e, t) {
		...
		valueSetsReplace(e, t, n) {
			let r = null;
			for (let i = 0, s = e.length; r === null && i < s; i++) r = this.valueSetReplace(e[i], t, n);
			return r;
		}
	...
	nr = Wi, nr.INSTANCE = new nr();
	const Hi = Object.freeze(function(e, t) {
	...
	var gn = class {
		...
		get onCancellationRequested() {
			return this._isCancelled ? Hi : (this._emitter || (this._emitter = new Me()), this._emitter.event);
		}
		dispose() {
	...
	const dn = new rr(), ir = new rr(), sr = new rr(), Gl = new Array(230), Jl = Object.create(null), Xl = Object.create(null), zi = [];
	for (let e = 0; e <= 193; e++) zi[e] = -1;
	(function() {
		const t = [
			[
				1,
		...
		for (const i of t) {
			...
			if (r[a] || (r[a] = !0, Jl[l] = a, Xl[l.toLowerCase()] = a, s && (zi[a] = o)), !n[o]) {
				if (n[o] = !0, !u) throw new Error(`String representation missing for key code ${o} around scan code ${l}`);
				dn.define(o, u), ir.define(o, g || u), sr.define(o, m || g || u);
			}
			h && (Gl[h] = o);
		}
	})();
	...
	(function(e) {
		...
		function s(l) {
			return ir.strToKeyCode(l) || sr.strToKeyCode(l);
		}
	...
	let ft;
	const ar = globalThis.vscode;
	if (typeof ar < "u" && typeof ar.process < "u") {
		const e = ar.process;
		ft = {
			get platform() {
				return e.platform;
	...
	} else typeof process < "u" && typeof process?.versions?.node == "string" ? ft = {
		get platform() {
		...
		get platform() {
			return Et ? "win32" : ll ? "darwin" : "linux";
		},
		get arch() {},
		get env() {
			return {};
	...
	const pn = ft.cwd, Zl = ft.env, Yl = ft.platform, Kl = 65, eu = 97, tu = 90, nu = 122, Ze = 46, ie = 47, he = 92, Ve = 58, ru = 63;
	...
	function iu(e, t) {
		if (e === null || typeof e != "object") throw new Ji(t, "Object", e);
	}
	function K(e, t) {
		if (typeof e != "string") throw new Ji(t, "string", e);
	}
	const qe = Yl === "win32";
	function U(e) {
		return e === ie || e === he;
	...
	function Xi(e, t) {
		iu(t, "pathObject");
		const n = t.dir || t.root, r = t.base || `${t.name || ""}${su(t.ext)}`;
	...
	const ce = {
		resolve(...e) {
			...
			for (let i = e.length - 1; i >= -1; i--) {
				...
				} else t.length === 0 ? s = pn() : (s = Zl[`=${t}`] || pn(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === he) && (s = `${t}\\`));
				const a = s.length;
				let l = 0, o = "", u = !1;
				...
				else De(h) && s.charCodeAt(1) === Ve && (o = s.slice(0, 2), l = 2, a > 2 && U(s.charCodeAt(2)) && (u = !0, l = 3));
		...
		normalize(e) {
			...
			else De(s) && e.charCodeAt(1) === Ve && (r = e.slice(0, 2), n = 2, t > 2 && U(e.charCodeAt(2)) && (i = !0, n = 3));
			let a = n < t ? bn(e.slice(n), !i, "\\", U) : "";
			if (a.length === 0 && !i && (a = "."), a.length > 0 && U(e.charCodeAt(t - 1)) && (a += "\\"), !i && r === void 0 && e.includes(":")) {
				if (a.length >= 2 && De(a.charCodeAt(0)) && a.charCodeAt(1) === Ve) return `.\\${a}`;
				let l = e.indexOf(":");
				do
		...
		isAbsolute(e) {
			...
			return U(n) || t > 2 && De(n) && e.charCodeAt(1) === Ve && U(e.charCodeAt(2));
		},
		join(...e) {
		...
		toNamespacedPath(e) {
			...
			if (t.charCodeAt(0) === he) {
				if (t.charCodeAt(1) === he) {
					...
					if (n !== ru && n !== Ze) return `\\\\?\\UNC\\${t.slice(2)}`;
				}
			} else if (De(t.charCodeAt(0)) && t.charCodeAt(1) === Ve && t.charCodeAt(2) === he) return `\\\\?\\${t}`;
			return t;
		},
		dirname(e) {
			K(e, "path");
			...
			} else De(i) && e.charCodeAt(1) === Ve && (n = t > 2 && U(e.charCodeAt(2)) ? 3 : 2, r = n);
			let s = -1, a = !0;
		...
		basename(e, t) {
			...
			let n = 0, r = -1, i = !0, s;
			if (e.length >= 2 && De(e.charCodeAt(0)) && e.charCodeAt(1) === Ve && (n = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
				if (t === e) return "";
		...
		extname(e) {
			...
			e.length >= 2 && e.charCodeAt(1) === Ve && De(e.charCodeAt(0)) && (t = r = 2);
			for (let l = e.length - 1; l >= t; --l) {
				...
				i === -1 && (s = !1, i = l + 1), o === Ze ? n === -1 ? n = l : a !== 1 && (a = 1) : n !== -1 && (a = -1);
			}
		...
		parse(e) {
			...
			} else if (De(i) && e.charCodeAt(1) === Ve) {
			...
			for (; u >= r; --u) {
				...
				l === -1 && (o = !1, l = u + 1), i === Ze ? s === -1 ? s = u : h !== 1 && (h = 1) : s !== -1 && (h = -1);
			}
		...
		resolve(...e) {
			...
			for (let r = e.length - 1; r >= 0 && !n; r--) {
				const i = e[r];
				K(i, `paths[${r}]`), i.length !== 0 && (t = `${i}/${t}`, n = i.charCodeAt(0) === ie);
			}
			if (!n) {
				const r = au();
				t = `${r}/${t}`, n = r.charCodeAt(0) === ie;
			}
			return t = bn(t, !n, "/", or), n ? `/${t}` : t.length > 0 ? t : ".";
		},
		normalize(e) {
			if (K(e, "path"), e.length === 0) return ".";
			const t = e.charCodeAt(0) === ie, n = e.charCodeAt(e.length - 1) === ie;
			return e = bn(e, !t, "/", or), e.length === 0 ? t ? "/" : n ? "./" : "." : (n && (e += "/"), t ? `/${e}` : e);
		},
		isAbsolute(e) {
			return K(e, "path"), e.length > 0 && e.charCodeAt(0) === ie;
		},
		join(...e) {
			if (e.length === 0) return ".";
			const t = [];
		...
		relative(e, t) {
			...
			if (u === l) if (a > l) {
				if (t.charCodeAt(s + u) === ie) return t.slice(s + u + 1);
				if (u === 0) return t.slice(s + u);
			} else i > l && (e.charCodeAt(n + u) === ie ? o = u : u === 0 && (o = 0));
			let h = "";
			for (u = n + o + 1; u <= r; ++u) (u === r || e.charCodeAt(u) === ie) && (h += h.length === 0 ? ".." : "/..");
		...
		basename(e, t) {
			...
			for (s = e.length - 1; s >= 0; --s) if (e.charCodeAt(s) === ie) {
				if (!i) {
					n = s + 1;
					break;
				}
		...
		parse(e) {
			...
			for (; o >= r; --o) {
				...
				a === -1 && (l = !1, a = o + 1), h === Ze ? i === -1 ? i = o : u !== 1 && (u = 1) : i !== -1 && (u = -1);
			}
			if (a !== -1) {
				const h = s === 0 && n ? 1 : s;
	...
	function cu(e, t) {
		...
		if (e.scheme && !ou.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
		if (e.path) {
			if (e.authority) {
	...
	var lr = class $n {
		...
		constructor(t, n, r, i, s, a = !1) {
			typeof t == "object" ? (this.scheme = t.scheme || Q, this.authority = t.authority || Q, this.path = t.path || Q, this.query = t.query || Q, this.fragment = t.fragment || Q) : (this.scheme = fu(t, a), this.authority = n || Q, this.path = hu(this.scheme, r || Q), this.query = i || Q, this.fragment = s || Q, cu(this, a));
		}
		get fsPath() {
			return ur(this, !1);
		}
		with(t) {
			...
			return n === void 0 ? n = this.scheme : n === null && (n = Q), r === void 0 ? r = this.authority : r === null && (r = Q), i === void 0 ? i = this.path : i === null && (i = Q), s === void 0 ? s = this.query : s === null && (s = Q), a === void 0 ? a = this.fragment : a === null && (a = Q), n === this.scheme && r === this.authority && i === this.path && s === this.query && a === this.fragment ? this : new ht(n, r, i, s, a);
		}
		static parse(t, n = !1) {
			const r = mu.exec(t);
			return r ? new ht(r[2] || Q, yn(r[4] || Q), yn(r[5] || Q), yn(r[7] || Q), yn(r[9] || Q), n) : new ht(Q, Q, Q, Q, Q);
		}
		static file(t) {
			let n = Q;
			if (Et && (t = t.replace(/\\/g, Ne)), t[0] === Ne && t[1] === Ne) {
				const r = t.indexOf(Ne, 2);
				r === -1 ? (n = t.substring(2), t = Ne) : (n = t.substring(2, r), t = t.substring(r) || Ne);
			}
			return new ht("file", n, t, Q, Q);
		}
		static from(t, n) {
			return new ht(t.scheme, t.authority, t.path, t.query, t.fragment, n);
		}
		static joinPath(t, ...n) {
			if (!t.path) throw new Error("[UriError]: cannot call joinPath on URI without path");
			let r;
			return Et && t.scheme === "file" ? r = $n.file(ce.join(ur(t, !0), ...n)).path : r = me.join(t.path, ...n), t.with({ path: r });
		}
		toString(t = !1) {
			return cr(this, t);
		}
		...
		static revive(t) {
			if (t) {
				...
				{
					const n = new ht(t);
					return n._formatted = t.external ?? null, n._fsPath = t._sep === Qi ? t.fsPath ?? null : null, n;
				}
			} else return t;
		}
	};
	const Qi = Et ? 1 : void 0;
	var ht = class extends lr {
		constructor() {
		...
		toString(e = !1) {
			return e ? cr(this, !0) : (this._formatted || (this._formatted = cr(this, !1)), this._formatted);
		}
		toJSON() {
			const e = { $mid: 1 };
			return this._fsPath && (e.fsPath = this._fsPath, e._sep = Qi), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e;
		}
	};
	const Zi = {
		58: "%3A",
	...
	function cr(e, t) {
		...
		return l && (r += "?", r += n(l, !1, !1)), o && (r += "#", r += t ? o : Yi(o, !1, !1)), r;
	}
	function Ki(e) {
		try {
	...
	const es = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
	function yn(e) {
		return e.match(es) ? e.replace(es, (t) => Ki(t)) : e;
	}
	var du = class Le extends B {
		constructor(t, n, r, i) {
		...
		static fromRange(t, n) {
			return n === 0 ? new Le(t.startLineNumber, t.startColumn, t.endLineNumber, t.endColumn) : new Le(t.endLineNumber, t.endColumn, t.startLineNumber, t.startColumn);
		}
		static liftSelection(t) {
			return new Le(t.selectionStartLineNumber, t.selectionStartColumn, t.positionLineNumber, t.positionColumn);
		}
	...
	var yu = class {
		...
		register(e, t) {
			return this._tokenizationSupports.set(e, t), this.handleChange([e]), sn(() => {
		...
		registerFactory(e, t) {
			...
			const n = new vu(this, e, t);
			return this._factories.set(e, n), sn(() => {
	...
	Ye = class Yt {
		static fromValue(t) {
			switch (t) {
				case "comment": return Yt.Comment;
				case "imports": return Yt.Imports;
				case "region": return Yt.Region;
			}
			return new Yt(t);
		}
		constructor(t) {
	...
	}, Ye.Comment = new Ye("comment"), Ye.Imports = new Ye("imports"), Ye.Region = new Ye("region");
	var fs;
	(function(e) {
	...
	Ct = s1, Ct.CtrlCmd = 2048, Ct.Shift = 1024, Ct.Alt = 512, Ct.WinCtrl = 256;
	function Lu() {
		return {
			editor: void 0,
			languages: void 0,
	...
	o1 = (l1 = Symbol.toStringTag, Symbol.iterator);
	a1 = class Kt {
		constructor(t, n) {
			if (this[l1] = "ResourceMap", t instanceof Kt) this.map = new Map(t.map), this.toKey = n ?? Kt.defaultToKey;
			else if (Su(t)) {
	...
	}, a1.defaultToKey = (e) => e.toString();
	var Au = class {
		constructor() {
			this[c1] = "LinkedMap", this._map = /* @__PURE__ */ new Map(), this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0;
		}
		clear() {
		...
		[(c1 = Symbol.toStringTag, Symbol.iterator)]() {
			return this.entries();
		}
		trimOld(e) {
	...
	var Cu = class {
		...
		next(e) {
			...
			do {
				...
				if (this._prevMatchStartIndex = r, this._prevMatchLength = i, !this._wordSeparators || Pu(this._wordSeparators, e, t, r, i)) return n;
			} while (n);
			return null;
		}
	};
	...
	function pr(e, t, n, r, i) {
		if (t = p1(t), i || (i = rn.first(b1)), n.length > i.maxLen) {
			let u = e - i.maxLen / 2;
			return u < 0 ? u = 0 : r += u, n = n.substring(u, e + i.maxLen / 2), pr(e, t, n, r, i);
		}
	...
	var Du = class {
		static computeUnicodeHighlights(e, t, n) {
			const r = n ? n.startLineNumber : 1, i = n ? n.endLineNumber : e.getLineCount(), s = new y1(t), a = s.getCandidateCodePoints();
			let l;
			a === "allNonBasicAscii" ? l = /* @__PURE__ */ new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : l = new RegExp(`${Ou(Array.from(a))}`, "g");
			const o = new Cu(null, l), u = [];
			...
			e: for (let p = r, v = i; p <= v; p++) {
				...
				do
					if (f = o.next(S), f) {
						...
						b > 0 && cn(S.charCodeAt(b - 1)) && b--, _ + 1 < N && cn(S.charCodeAt(_ - 1)) && _++;
						const y = S.substring(b, _);
						let A = pr(b + 1, d1, S, 0);
						A && A.endColumn <= b + 1 && (A = null);
						const L = s.shouldHighlightNonBasicASCII(y, A ? A.word : null);
						if (L !== 0) {
							if (L === 3 ? g++ : L === 2 ? m++ : L === 1 ? d++ : Uo(), u.length >= 1e3) {
								h = !0;
								break e;
							}
		...
		static computeUnicodeHighlightReason(e, t) {
			...
			switch (n.shouldHighlightNonBasicASCII(e, null)) {
				...
				case 3: {
					const r = e.codePointAt(0), i = n.ambiguousCharacters.getPrimaryConfusable(r), s = fn.getLocales().filter((a) => !fn.getInstance(new Set([...t.allowedLocales, a])).isAmbiguous(r));
					return {
						kind: 0,
	...
	function Ou(e, t) {
		return `[${gl(e.map((n) => String.fromCodePoint(n)).join(""))}]`;
	}
	var y1 = class {
		constructor(e) {
			this.options = e, this.allowedCodePoints = new Set(e.allowedCodePoints), this.ambiguousCharacters = fn.getInstance(new Set(e.allowedLocales));
		}
		getCandidateCodePoints() {
			if (this.options.nonBasicASCII) return "allNonBasicAscii";
			const e = /* @__PURE__ */ new Set();
			if (this.options.invisibleCharacters) for (const t of hn.codePoints) v1(String.fromCodePoint(t)) || e.add(t);
		...
		shouldHighlightNonBasicASCII(e, t) {
			...
			if (t) for (const s of t) {
				const a = s.codePointAt(0), l = Nl(s);
				r = r || l, !l && !this.ambiguousCharacters.isAmbiguous(a) && !hn.isInvisibleCharacter(a) && (i = !0);
			}
			return !r && i ? 0 : this.options.invisibleCharacters && !v1(e) && hn.isInvisibleCharacter(n) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(n) ? 3 : 0;
		}
	};
	function v1(e) {
		return e === " " || e === `
` || e === "	";
	...
	br = class ci {
		...
		filter(t) {
			return new ci((n) => this.iterate((r) => t(r) ? n(r) : !0));
		}
		map(t) {
			return new ci((n) => this.iterate((r) => n(t(r))));
		}
		findLast(t) {
			let n;
		...
		findLastMaxBy(t) {
			let n, r = !0;
			return this.iterate((i) => ((r || yr.isGreaterThan(t(i, n))) && (r = !1, n = i), !0)), n;
		}
	}, br.empty = new br((e) => {});
	var X = class ye {
		static fromTo(t, n) {
	...
	function gt(e, t, n = 0, r = e.length) {
		let i = n, s = r;
		for (; i < s;) {
	...
	function vr(e, t, n = 0, r = e.length) {
		let i = n, s = r;
		for (; i < s;) {
			const a = Math.floor((i + s) / 2);
			t(e[a]) ? s = a : i = a + 1;
	...
	var wr = class To {
		...
		findLastMonotonous(t) {
			...
			const n = gt(this._array, t, this._findLastMonotonousLastIdx);
			return this._findLastMonotonousLastIdx = n + 1, n === -1 ? void 0 : this._array[n];
		}
	};
	w1 = wr, w1.assertInvariants = !1;
	var _1, H = class xe {
		static ofLength(t, n) {
			return new xe(t, t + n);
		}
		...
		static joinMany(t) {
			...
			let n = new wn(t[0].slice());
			for (let r = 1; r < t.length; r++) n = n.getUnion(new wn(t[r].slice()));
			return n.ranges;
		}
		static join(t) {
	...
	_1 = H, _1.compareByStart = It((e) => e.startLineNumber, Ft);
	var wn = class Rt {
		constructor(t = []) {
		...
		addRange(t) {
			if (t.length === 0) return;
			const n = vr(this._normalizedRanges, (i) => i.endLineNumberExclusive >= t.startLineNumber), r = gt(this._normalizedRanges, (i) => i.startLineNumber <= t.endLineNumberExclusive) + 1;
		...
		contains(t) {
			const n = mt(this._normalizedRanges, (r) => r.startLineNumber <= t);
			return !!n && n.endLineNumberExclusive > t;
		}
		intersects(t) {
			const n = mt(this._normalizedRanges, (r) => r.startLineNumber < t.endLineNumberExclusive);
		...
		getUnion(t) {
			...
			for (; r < this._normalizedRanges.length || i < t._normalizedRanges.length;) {
				...
				s === null ? s = a : s.endLineNumberExclusive >= a.startLineNumber ? s = new H(s.startLineNumber, Math.max(s.endLineNumberExclusive, a.endLineNumberExclusive)) : (n.push(s), s = a);
			}
			return s !== null && n.push(s), new Rt(n);
		}
		subtractFrom(t) {
			const n = vr(this._normalizedRanges, (a) => a.endLineNumberExclusive >= t.startLineNumber), r = gt(this._normalizedRanges, (a) => a.startLineNumber <= t.endLineNumberExclusive) + 1;
			if (n === r) return new Rt([t]);
			const i = [];
			...
			return s < t.endLineNumberExclusive && i.push(new H(s, t.endLineNumberExclusive)), new Rt(i);
		}
		toString() {
		...
		static betweenPositions(t, n) {
			return t.lineNumber === n.lineNumber ? new Je(0, n.column - t.column) : new Je(n.lineNumber - t.lineNumber, n.column - 1);
		}
		static fromPosition(t) {
			return new Je(t.lineNumber - 1, t.column - 1);
		}
		static ofRange(t) {
			return Je.betweenPositions(t.getStartPosition(), t.getEndPosition());
		}
		static ofText(t) {
			let n = 0, r = 0;
			for (const i of t) i === `
` ? (n++, r = 0) : r++;
		...
		add(t) {
			return t.lineCount === 0 ? new Je(this.lineCount, this.columnCount + t.columnCount) : new Je(this.lineCount + t.lineCount, t.columnCount);
		}
		createRange(t) {
	...
	var L1, Ju = class {
		...
		getStringReplacement(e) {
			return new Vt.deps.StringReplacement(this.getOffsetRange(e.range), e.text);
		}
		getTextReplacement(e) {
			return new Vt.deps.TextReplacement(this.getRange(e.replaceRange), e.newText);
		}
		getTextEdit(e) {
			const t = e.replacements.map((n) => this.getTextReplacement(n));
			return new Vt.deps.TextEdit(t);
		}
	}, Vt = class {
		static get deps() {
	...
	L1 = Vt, L1._deps = void 0;
	var Xu = class extends Ju {
		constructor(e) {
...
` && (this.lineStartOffsetByLineIdx.push(t + 1), t > 0 && e.charAt(t - 1) === "\r" ? this.lineEndOffsetByLineIdx.push(t - 1) : this.lineEndOffsetByLineIdx.push(t));
		...
		getPosition(e) {
			const t = gt(this.lineStartOffsetByLineIdx, (n) => n <= e);
			return new J(t + 1, e - this.lineStartOffsetByLineIdx[t] + 1);
		}
		get textLength() {
			const e = this.lineStartOffsetByLineIdx.length - 1;
			return new Vt.deps.TextLength(e, this.text.length - this.lineStartOffsetByLineIdx[e]);
		}
		getLineLength(e) {
		...
		getTransformer() {
			return this._transformer || (this._transformer = new Xu(this.getValue())), this._transformer;
		}
		getLineAt(e) {
...
` + this._getLineContent(e.endLineNumber).substring(0, e.endColumn - 1), t;
		...
		get length() {
			...
			return new _n(this._lineCount - 1, e.length);
		}
	}, Ln = class extends Zu {
		constructor(e) {
		...
		static joinReplacements(t, n) {
			...
			return new at(B.fromPositions(r, i), s);
		}
		static fromStringReplacement(t, n) {
			return new at(n.getTransformer().getRange(t.replaceRange), t.newText);
		}
		static delete(t) {
			return new at(t, "");
		}
...
`, `
`), i = vl(n, r), s = _n.ofText(n.substring(0, i)).addToPosition(this.range.getStartPosition()), a = r.substring(i);
			return new at(B.fromPositions(s, this.range.getEndPosition()), a);
		}
...
`), r = this.text.replaceAll(`\r
`, `
`), i = wl(n, r), s = _n.ofText(n.substring(0, n.length - i)).addToPosition(this.range.getStartPosition()), a = r.substring(0, r.length - i);
			return new at(B.fromPositions(this.range.getStartPosition(), s), a);
		}
		toString() {
		...
		static inverse(t, n, r) {
			...
			let s = 1, a = 1;
			for (const o of t) {
				const u = new Mt(new H(s, o.original.startLineNumber), new H(a, o.modified.startLineNumber));
				u.modified.isEmpty || i.push(u), s = o.original.endLineNumberExclusive, a = o.modified.endLineNumberExclusive;
			}
			const l = new Mt(new H(s, n + 1), new H(a, r + 1));
		...
		static clip(t, n, r) {
			...
			for (const s of t) {
				...
				a && !a.isEmpty && l && !l.isEmpty && i.push(new Mt(a, l));
			}
			return i;
		}
		constructor(t, n) {
		...
		flip() {
			return new Mt(this.modified, this.original);
		}
		join(t) {
			return new Mt(this.original.join(t.original), this.modified.join(t.modified));
		}
		toRangeMapping() {
			...
			if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
				...
				return new Oe(new B(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new B(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
			} else return new Oe(new B(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new B(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER));
		}
		toRangeMapping2(t, n) {
			if (N1(this.original.endLineNumberExclusive, t) && N1(this.modified.endLineNumberExclusive, n)) return new Oe(new B(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new B(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
			if (!this.original.isEmpty && !this.modified.isEmpty) return new Oe(B.fromPositions(new J(this.original.startLineNumber, 1), pt(new J(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), B.fromPositions(new J(this.modified.startLineNumber, 1), pt(new J(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
			if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1) return new Oe(B.fromPositions(pt(new J(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), pt(new J(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), B.fromPositions(pt(new J(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), pt(new J(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
			throw new ue();
		}
	};
	function pt(e, t) {
	...
	var Dt = class Bn extends dt {
		static fromRangeMappings(t) {
			return new Bn(H.join(t.map((n) => H.fromRangeInclusive(n.originalRange))), H.join(t.map((n) => H.fromRangeInclusive(n.modifiedRange))), t);
		}
		constructor(t, n, r) {
	...
	function S1(e, t, n, r = !1) {
		const i = [];
		for (const s of Uu(e.map((a) => Ku(a, t, n)), (a, l) => a.original.intersectsOrTouches(l.original) || a.modified.intersectsOrTouches(l.modified))) {
			const a = s[0], l = s[s.length - 1];
			i.push(new Dt(a.original.join(l.original), a.modified.join(l.modified), s.map((o) => o.innerChanges[0])));
		}
		return nn(() => !r && i.length > 0 && (i[0].modified.startLineNumber !== i[0].original.startLineNumber || n.length.lineCount - i[i.length - 1].modified.endLineNumberExclusive !== t.length.lineCount - i[i.length - 1].original.endLineNumberExclusive) ? !1 : bi(i, (s, a) => a.original.startLineNumber - s.original.endLineNumberExclusive === a.modified.startLineNumber - s.modified.endLineNumberExclusive && s.original.endLineNumberExclusive < a.original.startLineNumber && s.modified.endLineNumberExclusive < a.modified.startLineNumber)), i;
	}
	function Ku(e, t, n) {
		let r = 0, i = 0;
		return e.modifiedRange.endColumn === 1 && e.originalRange.endColumn === 1 && e.originalRange.startLineNumber + r <= e.originalRange.endLineNumber && e.modifiedRange.startLineNumber + r <= e.modifiedRange.endLineNumber && (i = -1), e.modifiedRange.startColumn - 1 >= n.getLineLength(e.modifiedRange.startLineNumber) && e.originalRange.startColumn - 1 >= t.getLineLength(e.originalRange.startLineNumber) && e.originalRange.startLineNumber <= e.originalRange.endLineNumber + i && e.modifiedRange.startLineNumber <= e.modifiedRange.endLineNumber + i && (r = 1), new Dt(new H(e.originalRange.startLineNumber + r, e.originalRange.endLineNumber + 1 + i), new H(e.modifiedRange.startLineNumber + r, e.modifiedRange.endLineNumber + 1 + i), [e]);
	}
	const ec = 3;
	var tc = class {
		computeDiff(e, t, n) {
			...
			for (const a of r.changes) {
				let l;
				a.originalEndLineNumber === 0 ? l = new H(a.originalStartLineNumber + 1, a.originalStartLineNumber + 1) : l = new H(a.originalStartLineNumber, a.originalEndLineNumber + 1);
				let o;
				a.modifiedEndLineNumber === 0 ? o = new H(a.modifiedStartLineNumber + 1, a.modifiedStartLineNumber + 1) : o = new H(a.modifiedStartLineNumber, a.modifiedEndLineNumber + 1);
				let u = new Dt(l, o, a.charChanges?.map((h) => new Oe(new B(h.originalStartLineNumber, h.originalStartColumn, h.originalEndLineNumber, h.originalEndColumn), new B(h.modifiedStartLineNumber, h.modifiedStartColumn, h.modifiedEndLineNumber, h.modifiedEndColumn))));
				s && (s.modified.endLineNumberExclusive === u.modified.startLineNumber || s.original.endLineNumberExclusive === u.original.startLineNumber) && (u = new Dt(s.original.join(u.original), s.modified.join(u.modified), s.innerChanges && u.innerChanges ? s.innerChanges.concat(u.innerChanges) : void 0), i.pop()), i.push(u), s = u;
			}
			return nn(() => bi(i, (a, l) => l.original.startLineNumber - a.original.endLineNumberExclusive === l.modified.startLineNumber - a.modified.endLineNumberExclusive && a.original.endLineNumberExclusive < l.original.startLineNumber && a.modified.endLineNumberExclusive < l.modified.startLineNumber)), new vn(i, [], r.quitEarly);
		}
	};
	function A1(e, t, n, r) {
		return new qi(e, t, n).ComputeDiff(r);
	}
	var k1 = class {
		constructor(e) {
			const t = [], n = [];
			for (let r = 0, i = e.length; r < i; r++) t[r] = Nr(e[r], 1), n[r] = Sr(e[r], 1);
	...
	function rc(e) {
		...
		for (let r = 1, i = e.length; r < i; r++) {
			...
			Math.min(a, l) < ec ? (n.originalLength = s.originalStart + s.originalLength - n.originalStart, n.modifiedLength = s.modifiedStart + s.modifiedLength - n.modifiedStart) : (t.push(s), n = s);
		}
		return t;
	}
	var Lr = class Co {
		...
		static createFromDiffResult(t, n, r, i, s, a, l) {
			...
			if (n.originalLength === 0 ? (o = r.getStartLineNumber(n.originalStart) - 1, u = 0) : (o = r.getStartLineNumber(n.originalStart), u = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (h = i.getStartLineNumber(n.modifiedStart) - 1, f = 0) : (h = i.getStartLineNumber(n.modifiedStart), f = i.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && s()) {
				...
				if (m.getElements().length > 0 && d.getElements().length > 0) {
					let p = A1(m, d, s, !0).changes;
					l && (p = rc(p)), g = [];
					for (let v = 0, S = p.length; v < S; v++) g.push(Nn.createFromDiffChange(p[v], m, d));
				}
			}
			return new Co(o, u, h, f, g);
		}
	}, ic = class {
		constructor(e, t, n) {
			this.shouldComputeCharChanges = n.shouldComputeCharChanges, this.shouldPostProcessCharChanges = n.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = n.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = n.shouldMakePrettyDiff, this.originalLines = e, this.modifiedLines = t, this.original = new k1(e), this.modified = new k1(t), this.continueLineDiff = x1(n.maxComputationTime), this.continueCharDiff = x1(n.maxComputationTime === 0 ? 0 : Math.min(n.maxComputationTime, 5e3));
		}
		computeDiff() {
			...
			const e = A1(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff), t = e.changes, n = e.quitEarly;
			if (this.shouldIgnoreTrimWhitespace) {
				const a = [];
				for (let l = 0, o = t.length; l < o; l++) a.push(Lr.createFromDiffResult(this.shouldIgnoreTrimWhitespace, t[l], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
				return {
					quitEarly: n,
					changes: a
				};
			...
			for (let a = -1, l = t.length; a < l; a++) {
				...
				o && (r.push(Lr.createFromDiffResult(this.shouldIgnoreTrimWhitespace, o, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), i += o.originalLength, s += o.modifiedLength);
			}
			return {
				quitEarly: n,
				changes: r
		...
		_pushTrimWhitespaceCharChange(e, t, n, r, i, s, a) {
			...
			let l;
			this.shouldComputeCharChanges && (l = [new Nn(t, n, t, r, i, s, i, a)]), e.push(new Lr(t, t, i, i, l));
		}
	...
	var Ot, Ar, bt = class hi {
		static trivial(t, n) {
			return new hi([new ge(X.ofLength(t.length), X.ofLength(n.length))], !1);
		}
		static trivialTimedOut(t, n) {
			return new hi([new ge(X.ofLength(t.length), X.ofLength(n.length))], !0);
		}
		constructor(t, n) {
		...
		static invert(t, n) {
			const r = [];
			return qu(t, (i, s) => {
				r.push(Be.fromOffsetPairs(i ? i.getEndExclusives() : je.zero, s ? s.getStarts() : new je(n, (i ? i.seq2Range.endExclusive - i.seq1Range.endExclusive : 0) + n)));
			}), r;
		}
		...
		delta(t) {
			return t === 0 ? this : new Io(this.offset1 + t, this.offset2 + t);
		}
		equals(t) {
			return this.offset1 === t.offset1 && this.offset2 === t.offset2;
		}
	};
	Ot = je, Ot.zero = new Ot(0, 0), Ot.max = new Ot(Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER);
	var Sn = class {
		isValid() {
			return !0;
		}
	};
	Ar = Sn, Ar.instance = new Ar();
	var sc = class {
		constructor(e) {
...
`);
	...
	R1 = Rr, R1.chrKeys = /* @__PURE__ */ new Map();
	var ac = class {
		compute(e, t, n = Sn.instance, r) {
			if (e.length === 0 || t.length === 0) return bt.trivial(e, t);
			const i = new kr(e.length, t.length), s = new kr(e.length, t.length), a = new kr(e.length, t.length);
		...
		compute(e, t, n = Sn.instance) {
			...
			e: for (;;) {
				...
				for (u = d; u <= p; u += 2) {
					...
					if (o.set(u, _ !== N ? new E1(y, N, b, _ - N) : y), l.get(u) === r.length && l.get(u) - u === i.length) break e;
				}
			}
			let h = o.get(u);
			const f = [];
		...
		getBoundaryScore(e) {
			...
			if (t === 8) return 150;
			let r = 0;
			return t !== n && (r += 10, t === 0 && n === 1 && (r += 1)), r += P1(t), r += P1(n), r;
		}
		translateOffset(e, t = "right") {
			const n = gt(this.firstElementOffsetByLineIdx, (i) => i <= e), r = e - this.firstElementOffsetByLineIdx[n];
		...
		findWordContaining(e) {
			if (e < 0 || e >= this.elements.length || !yt(this.elements[e])) return;
			let t = e;
			for (; t > 0 && yt(this.elements[t - 1]);) t--;
			let n = e;
			for (; n < this.elements.length && yt(this.elements[n]);) n++;
			return new X(t, n);
		}
		findSubWordContaining(e) {
			if (e < 0 || e >= this.elements.length || !yt(this.elements[e])) return;
			let t = e;
			for (; t > 0 && yt(this.elements[t - 1]) && !T1(this.elements[t]);) t--;
			let n = e;
			for (; n < this.elements.length && yt(this.elements[n]) && !T1(this.elements[n]);) n++;
			return new X(t, n);
		}
		countLinesIn(e) {
		...
		extendToFullLines(e) {
			return new X(mt(this.firstElementOffsetByLineIdx, (t) => t <= e.start) ?? 0, Gu(this.firstElementOffsetByLineIdx, (t) => e.endExclusive <= t) ?? this.elements.length);
		}
	};
	function yt(e) {
	...
	function C1(e) {
		return e === 10 ? 8 : e === 13 ? 7 : xr(e) ? 6 : e >= 97 && e <= 122 ? 0 : e >= 65 && e <= 90 ? 1 : e >= 48 && e <= 57 ? 2 : e === -1 ? 3 : e === 44 || e === 59 ? 5 : 4;
	}
	function cc(e, t, n, r, i, s) {
		let { moves: a, excludedChanges: l } = hc(e, t, n, s);
		if (!s.isValid()) return [];
		const o = mc(e.filter((u) => !l.has(u)), r, i, t, n, s);
		return Wu(a, o), a = gc(a), a = a.filter((u) => {
			const h = u.original.toOffsetRange().slice(t).map((f) => f.trim());
			return h.join(`
`).length >= 15 && fc(h, (f) => f.length >= 2) >= 2;
		}), a = dc(e, a), a;
	}
	function fc(e, t) {
		let n = 0;
	...
	function hc(e, t, n, r) {
		const i = [], s = e.filter((o) => o.modified.isEmpty && o.original.length >= 3).map((o) => new Rr(o.original, t, o)), a = new Set(e.filter((o) => o.original.isEmpty && o.modified.length >= 3).map((o) => new Rr(o.modified, n, o))), l = /* @__PURE__ */ new Set();
		for (const o of s) {
			let u = -1, h;
			for (const f of a) {
			...
			if (u > .9 && h && (a.delete(h), i.push(new dt(o.range, h.range)), l.add(o.source), l.add(h.source)), !r.isValid()) return {
				moves: i,
				excludedChanges: l
			};
		}
	...
	function mc(e, t, n, r, i, s) {
		...
		for (const g of e) for (let m = g.original.startLineNumber; m < g.original.endLineNumberExclusive - 2; m++) {
			...
			l.add(d, { range: new H(m, m + 3) });
		}
		const o = [];
		e.sort(It((g) => g.modified.startLineNumber, Ft));
		for (const g of e) {
			let m = [];
			for (let d = g.modified.startLineNumber; d < g.modified.endLineNumberExclusive - 2; d++) {
				const p = `${n[d - 1]}:${n[d + 1 - 1]}:${n[d + 2 - 1]}`, v = new H(d, d + 3), S = [];
				l.forEach(p, ({ range: N }) => {
					for (const _ of m) if (_.originalLineRange.endLineNumberExclusive + 1 === N.endLineNumberExclusive && _.modifiedLineRange.endLineNumberExclusive + 1 === v.endLineNumberExclusive) {
						_.originalLineRange = new H(_.originalLineRange.startLineNumber, N.endLineNumberExclusive), _.modifiedLineRange = new H(_.modifiedLineRange.startLineNumber, v.endLineNumberExclusive), S.push(_);
						return;
					}
					const b = {
						modifiedLineRange: v,
		...
		o.sort(Hu(It((g) => g.modifiedLineRange.length, Ft)));
		const u = new wn(), h = new wn();
		for (const g of o) {
			...
			for (const S of v.ranges) {
				...
				a.push(new dt(b, N)), u.addRange(N), h.addRange(b);
			}
		}
		a.sort(It((g) => g.original.startLineNumber, Ft));
		const f = new wr(e);
		for (let g = 0; g < a.length; g++) {
			const m = a[g], d = f.findLastMonotonous((A) => A.original.startLineNumber <= m.original.startLineNumber), p = mt(e, (A) => A.modified.startLineNumber <= m.modified.startLineNumber), v = Math.max(m.original.startLineNumber - d.original.startLineNumber, m.modified.startLineNumber - p.modified.startLineNumber), S = f.findLastMonotonous((A) => A.original.startLineNumber < m.original.endLineNumberExclusive), N = mt(e, (A) => A.modified.startLineNumber < m.modified.endLineNumberExclusive), b = Math.max(S.original.endLineNumberExclusive - m.original.endLineNumberExclusive, N.modified.endLineNumberExclusive - m.modified.endLineNumberExclusive);
			let _;
			for (_ = 0; _ < v; _++) {
				const A = m.original.startLineNumber - _ - 1, L = m.modified.startLineNumber - _ - 1;
				if (A > r.length || L > i.length || u.contains(L) || h.contains(A) || !I1(r[A - 1], i[L - 1], s)) break;
			}
			_ > 0 && (h.addRange(new H(m.original.startLineNumber - _, m.original.startLineNumber)), u.addRange(new H(m.modified.startLineNumber - _, m.modified.startLineNumber)));
			let y;
			for (y = 0; y < b; y++) {
				const A = m.original.endLineNumberExclusive + y, L = m.modified.endLineNumberExclusive + y;
				if (A > r.length || L > i.length || u.contains(L) || h.contains(A) || !I1(r[A - 1], i[L - 1], s)) break;
			}
			y > 0 && (h.addRange(new H(m.original.endLineNumberExclusive, m.original.endLineNumberExclusive + y)), u.addRange(new H(m.modified.endLineNumberExclusive, m.modified.endLineNumberExclusive + y))), (_ > 0 || y > 0) && (a[g] = new dt(new H(m.original.startLineNumber - _, m.original.endLineNumberExclusive + y), new H(m.modified.startLineNumber - _, m.modified.endLineNumberExclusive + y)));
		}
		return a;
	}
	function I1(e, t, n) {
		...
		const r = new M1().compute(new An([e], new B(1, 1, 1, e.length), !1), new An([t], new B(1, 1, 1, t.length), !1), n);
		let i = 0;
		...
		function a(o) {
			let u = 0;
			for (let h = 0; h < e.length; h++) xr(o.charCodeAt(h)) || u++;
			return u;
		}
	...
	function gc(e) {
		...
		e.sort(It((n) => n.original.startLineNumber, Ft));
		const t = [e[0]];
	...
	function dc(e, t) {
		const n = new wr(e);
		return t = t.filter((r) => (n.findLastMonotonous((i) => i.original.startLineNumber < r.original.endLineNumberExclusive) || new dt(new H(1, 1), new H(1, 1))) !== mt(e, (i) => i.modified.startLineNumber < r.modified.endLineNumberExclusive)), t;
	}
	function F1(e, t, n) {
		let r = n;
		return r = V1(e, t, r), r = V1(e, t, r), r = pc(e, t, r), r;
	}
	function V1(e, t, n) {
	...
	function pc(e, t, n) {
		...
		for (let r = 0; r < n.length; r++) {
			...
			s.seq1Range.isEmpty ? n[r] = D1(s, e, t, l, o) : s.seq2Range.isEmpty && (n[r] = D1(s.swap(), t, e, o, l).swap());
		}
		return n;
	}
	...
	function wc(e, t, n) {
		...
		do {
			...
			for (let u = 1; u < r.length; u++) {
				let g = function(m, d) {
					...
					const S = e.countLinesIn(m.seq1Range), N = m.seq1Range.length, b = t.countLinesIn(m.seq2Range), _ = m.seq2Range.length, y = e.countLinesIn(d.seq1Range), A = d.seq1Range.length, L = t.countLinesIn(d.seq2Range), T = d.seq2Range.length, I = 130;
					function D(M) {
						return Math.min(M, I);
					}
					return Math.pow(Math.pow(D(S * 40 + N), 1.5) + Math.pow(D(b * 40 + _), 1.5), 1.5) + Math.pow(Math.pow(D(y * 40 + A), 1.5) + Math.pow(D(L * 40 + T), 1.5), 1.5) > (I ** 1.5) ** 1.5 * 1.3;
				};
		...
		return ju(r, (o, u, h) => {
			...
			const v = ge.fromOffsetPairs(o ? o.getEndExclusives() : je.zero, h ? h.getStarts() : je.max), S = f.intersect(v);
	...
	var $1 = class {
		...
		getBoundaryScore(e) {
			return 1e3 - ((e === 0 ? 0 : B1(this.lines[e - 1])) + (e === this.lines.length ? 0 : B1(this.lines[e])));
		}
		getText(e) {
...
`);
	...
	var _c = class {
		constructor() {
			this.dynamicProgrammingDiffing = new ac(), this.myersDiffingAlgorithm = new M1();
		}
		computeDiff(e, t, n) {
			if (e.length <= 1 && Bu(e, t, (_, y) => _ === y)) return new vn([], [], !1);
			if (e.length === 1 && e[0].length === 0 || t.length === 1 && t[0].length === 0) return new vn([new Dt(new H(1, e.length + 1), new H(1, t.length + 1), [new Oe(new B(1, 1, e.length, e[e.length - 1].length + 1), new B(1, 1, t.length, t[t.length - 1].length + 1))])], [], !1);
			const r = n.maxComputationTimeMs === 0 ? Sn.instance : new sc(n.maxComputationTimeMs), i = !n.ignoreTrimWhitespace, s = /* @__PURE__ */ new Map();
			function a(_) {
				let y = s.get(_);
				return y === void 0 && (y = s.size, s.set(_, y)), y;
			}
			const l = e.map((_) => a(_.trim())), o = t.map((_) => a(_.trim())), u = new $1(l, e), h = new $1(o, t), f = u.length + h.length < 1700 ? this.dynamicProgrammingDiffing.compute(u, h, r, (_, y) => e[_] === t[y] ? t[y].length === 0 ? .1 : 1 + Math.log(1 + t[y].length) : .99) : this.myersDiffingAlgorithm.compute(u, h, r);
			let g = f.diffs, m = f.hitTimeout;
			g = F1(u, h, g), g = vc(u, h, g);
			const d = [], p = (_) => {
				if (i) for (let y = 0; y < _; y++) {
					const A = v + y, L = S + y;
					if (e[A] !== t[L]) {
						const T = this.refineDiff(e, t, new ge(new X(A, A + 1), new X(L, L + 1)), r, i, n);
			...
			let v = 0, S = 0;
			for (const _ of g) {
				nn(() => _.seq1Range.start - v === _.seq2Range.start - S), p(_.seq1Range.start - v), v = _.seq1Range.endExclusive, S = _.seq2Range.endExclusive;
				const y = this.refineDiff(e, t, _, r, i, n);
				y.hitTimeout && (m = !0);
				for (const A of y.mappings) d.push(A);
			}
			p(e.length - v);
			const N = S1(d, new Ln(e), new Ln(t));
			let b = [];
			return n.computeMoves && (b = this.computeMoves(N, e, t, l, o, r, i, n)), nn(() => {
				function _(A, L) {
					if (A.lineNumber < 1 || A.lineNumber > L.length) return !1;
					const T = L[A.lineNumber - 1];
					return !(A.column < 1 || A.column > T.length + 1);
				}
				function y(A, L) {
					return !(A.startLineNumber < 1 || A.startLineNumber > L.length + 1 || A.endLineNumberExclusive < 1 || A.endLineNumberExclusive > L.length + 1);
				}
				for (const A of N) {
					if (!A.innerChanges) return !1;
					for (const L of A.innerChanges) if (!(_(L.modifiedRange.getStartPosition(), t) && _(L.modifiedRange.getEndPosition(), t) && _(L.originalRange.getStartPosition(), e) && _(L.originalRange.getEndPosition(), e))) return !1;
		...
		computeMoves(e, t, n, r, i, s, a, l) {
			return cc(e, t, n, r, i, s).map((o) => new $u(o, S1(this.refineDiff(t, n, new ge(o.original.toOffsetRange(), o.modified.toOffsetRange()), s, a, l).mappings, new Ln(t), new Ln(n), !0)));
		}
		refineDiff(e, t, n, r, i, s) {
			const a = Lc(n).toRangeMapping2(e, t), l = new An(e, a.originalRange, i), o = new An(t, a.modifiedRange, i), u = l.length + o.length < 500 ? this.dynamicProgrammingDiffing.compute(l, o, r) : this.myersDiffingAlgorithm.compute(l, o, r);
			let h = u.diffs;
			return h = F1(l, o, h), h = O1(l, o, h, (f, g) => f.findWordContaining(g)), s.extendToSubwords && (h = O1(l, o, h, (f, g) => f.findSubWordContaining(g), !0)), h = bc(l, o, h), h = wc(l, o, h), {
	...
	function Lc(e) {
		return new dt(new H(e.seq1Range.start + 1, e.seq1Range.endExclusive + 1), new H(e.seq2Range.start + 1, e.seq2Range.endExclusive + 1));
	}
	const U1 = {
		getLegacy: () => new tc(),
		getDefault: () => new _c()
	...
	var k = class {
		...
		static toRGBA(t) {
			...
			if (r === 0) a = l = o = i;
				...
				a = en._hue2rgb(h, u, n + 1 / 3), l = en._hue2rgb(h, u, n), o = en._hue2rgb(h, u, n - 1 / 3);
			}
		...
		static fromHex(t) {
			return ve.Format.CSS.parseHex(t) || ve.red;
		}
		static equals(t, n) {
		...
		get hsva() {
			return this._hsva ? this._hsva : kn.fromRGBA(this.rgba);
		}
		constructor(t) {
			if (t) if (t instanceof k) this.rgba = t;
			else if (t instanceof Ke) this._hsla = t, this.rgba = Ke.toRGBA(t);
			else if (t instanceof kn) this._hsva = t, this.rgba = kn.toRGBA(t);
			else throw new Error("Invalid color ctor argument");
			else throw new Error("Color needs a value");
		}
		equals(t) {
			return !!t && k.equals(this.rgba, t.rgba) && Ke.equals(this.hsla, t.hsla) && kn.equals(this.hsva, t.hsva);
		}
		getRelativeLuminance() {
			const t = ve._relativeLuminanceForComponent(this.rgba.r), n = ve._relativeLuminanceForComponent(this.rgba.g), r = ve._relativeLuminanceForComponent(this.rgba.b);
		...
		lighten(t) {
			return new ve(new Ke(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * t, this.hsla.a));
		}
		darken(t) {
			return new ve(new Ke(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * t, this.hsla.a));
		}
		...
		opposite() {
			return new ve(new k(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
		}
		mix(t, n = .5) {
			const r = Math.min(Math.max(n, 0), 1), i = this.rgba, s = t.rgba;
			return new ve(new k(i.r + (s.r - i.r) * r, i.g + (s.g - i.g) * r, i.b + (s.b - i.b) * r, i.a + (s.a - i.a) * r));
		}
		makeOpaque(t) {
			if (this.isOpaque() || t.rgba.a !== 1) return this;
			const { r: n, g: r, b: i, a: s } = this.rgba;
			return new ve(new k(t.rgba.r - s * (t.rgba.r - n), t.rgba.g - s * (t.rgba.g - r), t.rgba.b - s * (t.rgba.b - i), 1));
		}
		toString() {
	...
	ae = $t, ae.white = new ae(new k(255, 255, 255, 1)), ae.black = new ae(new k(0, 0, 0, 1)), ae.red = new ae(new k(255, 0, 0, 1)), ae.blue = new ae(new k(0, 0, 255, 1)), ae.green = new ae(new k(0, 255, 0, 1)), ae.cyan = new ae(new k(0, 255, 255, 1)), ae.lightgrey = new ae(new k(211, 211, 211, 1)), ae.transparent = new ae(new k(0, 0, 0, 0)), (function(e) {
		(function(t) {
			(function(n) {
				function r(p) {
				...
				function m(p) {
					...
					if (v === 5) {
						const S = d(p.charCodeAt(1)), N = d(p.charCodeAt(2)), b = d(p.charCodeAt(3)), _ = d(p.charCodeAt(4));
						return new e(new k(16 * S + S, 16 * N + N, 16 * b + b, (16 * _ + _) / 255));
					}
					return null;
				}
				n.parseHex = m;
	...
	function Nc(e, t) {
		if (!e) return;
		const n = $t.Format.CSS.parseHex(t);
		if (n) return {
			range: e,
			color: Mr(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
		};
	}
	function j1(e, t, n) {
		if (!e || t.length !== 1) return;
		const r = q1(t[0].values());
		return {
			range: e,
			color: Mr(r[0], r[1], r[2], n ? r[3] : 1)
		};
	}
	function W1(e, t, n) {
		if (!e || t.length !== 1) return;
		const r = q1(t[0].values()), i = new $t(new Ke(r[0], r[1] / 100, r[2] / 100, n ? r[3] : 1));
		return {
			range: e,
			color: Mr(i.rgba.r, i.rgba.g, i.rgba.b, i.rgba.a)
		};
	}
	function Ut(e, t) {
	...
	function Sc(e) {
		const t = [], n = Ut(e, /\b(rgb|rgba|hsl|hsla)(\([0-9\s,.\%]*\))|^(#)([A-Fa-f0-9]{3})\b|^(#)([A-Fa-f0-9]{4})\b|^(#)([A-Fa-f0-9]{6})\b|^(#)([A-Fa-f0-9]{8})\b|(?<=['"\s])(#)([A-Fa-f0-9]{3})\b|(?<=['"\s])(#)([A-Fa-f0-9]{4})\b|(?<=['"\s])(#)([A-Fa-f0-9]{6})\b|(?<=['"\s])(#)([A-Fa-f0-9]{8})\b/gm);
		if (n.length > 0) for (const r of n) {
			const i = r.filter((o) => o !== void 0), s = i[1], a = i[2];
			if (!a) continue;
			let l;
			s === "rgb" ? l = j1(Bt(e, r), Ut(a, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*\)$/gm), !1) : s === "rgba" ? l = j1(Bt(e, r), Ut(a, /^\(\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[0-9])\s*,\s*(0[.][0-9]+|[.][0-9]+|[01][.]|[01])\s*\)$/gm), !0) : s === "hsl" ? l = W1(Bt(e, r), Ut(a, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*\)$/gm), !1) : s === "hsla" ? l = W1(Bt(e, r), Ut(a, /^\(\s*((?:360(?:\.0+)?|(?:36[0]|3[0-5][0-9]|[12][0-9][0-9]|[1-9]?[0-9])(?:\.\d+)?))\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(100|\d{1,2}[.]\d*|\d{1,2})%\s*[\s,]\s*(0[.][0-9]+|[.][0-9]+|[01][.]0*|[01])\s*\)$/gm), !0) : s === "#" && (l = Nc(Bt(e, r), s + a)), l && t.push(l);
		}
		return t;
	}
	function Ac(e) {
		return !e || typeof e.getValue != "function" || typeof e.positionAt != "function" ? [] : Sc(e);
	}
	const kc = /^-+|-+$/g, H1 = 100, xc = 5;
	function Rc(e, t) {
		let n = [];
	...
	function Ec(e, t) {
		...
		const i = Mu(t.markSectionHeaderRegex), s = new RegExp(t.markSectionHeaderRegex, `gdm${i ? "s" : ""}`);
		if (dl(s)) return n;
		for (let a = 1; a <= r; a += H1 - xc) {
			const l = Math.min(a + H1 - 1, r), o = [];
...
`) + 1, N = h.index - S + 1, b = d[d.length - 1], _ = {
					range: {
						startLineNumber: m,
						startColumn: N,
						endLineNumber: v,
	...
	var Vc = class {
		...
		setValue(e, t) {
			return e = ct(e), t = ct(t), this.values[e] === t ? !1 : (this.values[e] = t, e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), !0);
		}
		removeValues(e, t) {
			e = ct(e), t = ct(t);
		...
		$acceptNewModel(e) {
			this._models[e.url] = new Bc(lr.parse(e.url), e.lines, e.EOL, e.versionId);
		}
		...
		getWordAtPosition(e, t) {
			const n = pr(e.column, p1(t), this._lines[e.lineNumber - 1], 0);
		...
		constructor(t = null) {
			this._foreignModule = t, this._requestHandlerBrand = void 0, this._workerTextModelSyncServer = new $c();
		}
		dispose() {}
		async $ping() {
			return "pong";
		...
		async $computeDiff(t, n, r, i) {
			...
			return !s || !a ? null : Un.computeDiff(s, a, r, i);
		}
		static computeDiff(t, n, r, i) {
			const s = i === "advanced" ? U1.getDefault() : U1.getLegacy(), a = t.getLinesContent(), l = n.getLinesContent(), o = s.computeDiff(a, l, r), u = o.changes.length > 0 ? !1 : this._modelsAreIdentical(t, n);
			function h(f) {
				return f.map((g) => [
		...
		async $computeMoreMinimalEdits(t, n, r) {
			...
			for (let { range: o, text: u, eol: h } of n) {
				...
				if (Math.max(u.length, f.length) > Un._diffLimit) {
					s.push({
						range: o,
						text: u
					});
				...
				const g = Ol(f, u, r), m = i.offsetAt(B.lift(o).getStartPosition());
				for (const d of g) {
		...
		async $textualSuggest(t, n, r, i) {
			const s = new _i(), a = new RegExp(r, i), l = /* @__PURE__ */ new Set();
			e: for (const o of t) {
				const u = this._getModel(o);
				if (u) {
					for (const h of u.words(a)) if (!(h === n || !isNaN(Number(h))) && (l.add(h), l.size > Un._suggestionsLimit)) break e;
				}
			}
			return {
				words: Array.from(l),
		...
		async $navigateValueSet(t, n, r, i, s) {
			...
			return Wi.INSTANCE.navigateValueSet(n, o, u, h, r);
		}
		$fmr(t, n) {
	...
	Pr = J1, Pr._diffLimit = 1e5, Pr._suggestionsLimit = 1e4, typeof importScripts == "function" && (globalThis.monaco = Lu());
	var X1, Q1 = class gi {
		static getChannel(t) {
			return t.getChannel(gi.CHANNEL_NAME);
		}
		static setChannel(t, n) {
			t.setChannel(gi.CHANNEL_NAME, n);
		}
	};
	X1 = Q1, X1.CHANNEL_NAME = "editorWorkerHost";
	function Uc(e) {
		let t;
		const n = Cl((r) => {
			const i = Q1.getChannel(r);
			return t = e({
	...
	function Cr(e, t = !1) {
		...
		function g(b, _) {
			...
			for (; y < b;) {
				...
				if (L >= 48 && L <= 57) A = A * 16 + L - 48;
				else if (L >= 65 && L <= 70) A = A * 16 + L - 65 + 10;
				else if (L >= 97 && L <= 102) A = A * 16 + L - 97 + 10;
				else break;
				r++, y++;
			}
			return y < b && (A = -1), A;
		...
		function d() {
			...
			else for (r++; r < e.length && vt(e.charCodeAt(r));) r++;
			if (r < e.length && e.charCodeAt(r) === 46) if (r++, r < e.length && vt(e.charCodeAt(r))) for (r++; r < e.length && vt(e.charCodeAt(r));) r++;
			else return f = 3, e.substring(b, r);
			let _ = r;
			if (r < e.length && (e.charCodeAt(r) === 69 || e.charCodeAt(r) === 101)) if (r++, (r < e.length && e.charCodeAt(r) === 43 || e.charCodeAt(r) === 45) && r++, r < e.length && vt(e.charCodeAt(r))) {
				for (r++; r < e.length && vt(e.charCodeAt(r));) r++;
				_ = r;
			} else f = 3;
...
`;
		...
		function v() {
			...
			if (qt(b)) return r++, i += String.fromCharCode(b), b === 13 && e.charCodeAt(r) === 10 && (r++, i += `
`), l++, u = r, a = 14;
			switch (b) {
				...
				case 47:
					...
					if (e.charCodeAt(r + 1) === 47) {
						for (r += 2; r < n && !qt(e.charCodeAt(r));) r++;
					...
					if (e.charCodeAt(r + 1) === 42) {
						...
						for (; r < y;) {
							...
							r++, qt(L) && (L === 13 && e.charCodeAt(r) === 10 && r++, l++, u = r);
						}
						return A || (r++, f = 1), i = e.substring(_, r), a = 13;
					}
					return i += String.fromCharCode(b), r++, a = 16;
				case 45: if (i += String.fromCharCode(b), r++, r === n || !vt(e.charCodeAt(r))) return a = 16;
				case 48:
				case 49:
				case 50:
				case 51:
	...
	const we = new Array(20).fill(0).map((e, t) => " ".repeat(t)), wt = 200, Y1 = {
		" ": {
			"\n": new Array(wt).fill(0).map((e, t) => `
` + " ".repeat(t)),
			"\r": new Array(wt).fill(0).map((e, t) => "\r" + " ".repeat(t)),
			"\r\n": new Array(wt).fill(0).map((e, t) => `\r
` + " ".repeat(t))
		},
		"	": {
			"\n": new Array(wt).fill(0).map((e, t) => `
...
`
	...
	function Hc(e, t, n) {
		let r, i, s, a, l;
		if (t) {
			for (a = t.offset, l = a + t.length, s = a; s > 0 && !K1(e, s - 1);) s--;
			let y = l;
			for (; y < e.length && !K1(e, y);) y++;
			i = e.substring(s, y), r = zc(i, n);
		} else i = e, r = 0, s = 0, a = 0, l = e.length;
		const o = Gc(n, e), u = Wc.includes(o);
		let h = 0, f = 0, g;
		n.insertSpaces ? g = we[n.tabSize || 4] ?? _t(we[1], n.tabSize || 4) : g = "	";
		const m = g === "	" ? "	" : " ";
		let d = Cr(i, !1), p = !1;
		function v() {
			if (h > 1) return _t(o, h) + _t(g, r + f);
			const y = g.length * (r + f);
			return !u || y > Y1[m][o].length ? o + _t(g, r + f) : y <= 0 ? o : Y1[m][o][y];
		}
		function S() {
			let y = d.scan();
		...
		const N = [];
		function b(y, A, L) {
			!p && (!t || A < l && L > a) && e.substring(A, L) !== y && N.push({
				offset: A,
				length: L - A,
				content: y
			});
		...
		let _ = S();
		if (n.keepLines && h > 0 && b(_t(o, h), 0, 0), _ !== 17) {
			let y = d.getTokenOffset() + s;
			b(g.length * r < 20 && n.insertSpaces ? we[g.length * r] : _t(g, r), s, y);
		}
		for (; _ !== 17;) {
			let y = d.getTokenOffset() + d.getTokenLength() + s, A = S(), L = "", T = !1;
			for (; h === 0 && (A === 12 || A === 13);) {
				let D = d.getTokenOffset() + s;
				b(we[1], y, D), y = d.getTokenOffset() + d.getTokenLength() + s, T = A === 12, L = T ? v() : "", A = S();
			}
			if (A === 2) _ !== 1 && f--, n.keepLines && h > 0 || !n.keepLines && _ !== 1 ? L = v() : n.keepLines && (L = we[1]);
			else if (A === 4) _ !== 3 && f--, n.keepLines && h > 0 || !n.keepLines && _ !== 3 ? L = v() : n.keepLines && (L = we[1]);
			else {
				switch (_) {
					case 3:
					case 1:
						f++, n.keepLines && h > 0 || !n.keepLines ? L = v() : L = we[1];
						break;
					case 5:
						n.keepLines && h > 0 || !n.keepLines ? L = v() : L = we[1];
						break;
					case 12:
						L = v();
						break;
					case 13:
						...
						break;
					case 6:
						n.keepLines && h > 0 ? L = v() : T || (L = we[1]);
						break;
					case 10:
						n.keepLines && h > 0 ? L = v() : A === 6 && !T && (L = "");
						break;
					case 7:
					case 8:
					case 9:
					...
					case 2:
					case 4:
						n.keepLines && h > 0 ? L = v() : (A === 12 || A === 13) && !T ? L = we[1] : A !== 5 && A !== 17 && (p = !0);
						break;
					case 16:
						p = !0;
						break;
			...
			A === 17 && (n.keepLines && h > 0 ? L = v() : L = n.insertFinalNewline ? o : "");
...
`.indexOf(e.charAt(t)) !== -1;
	...
	function Fr(e) {
		switch (e.type) {
			case "array": return e.children.map(Fr);
			case "object":
				const t = Object.create(null);
				for (let n of e.children) {
					const r = n.children[1];
					r && (t[n.children[0].value] = Fr(r));
				}
				return t;
			case "null":
			case "string":
	...
	function Qc(e, t, n = xn.DEFAULT) {
		const r = Cr(e, !1), i = [];
		function s(w) {
			return w ? () => w(r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter()) : () => !0;
		}
		function a(w) {
			return w ? () => w(r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter(), () => i.slice()) : () => !0;
		}
		function l(w) {
			return w ? (R) => w(R, r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter()) : () => !0;
		}
		function o(w) {
			return w ? (R) => w(R, r.getTokenOffset(), r.getTokenLength(), r.getTokenStartLine(), r.getTokenStartCharacter(), () => i.slice()) : () => !0;
		}
		...
		function I() {
			...
			for (; r.getToken() !== 2 && r.getToken() !== 17;) {
				if (r.getToken() === 5) {
					if (w || y(4, [], []), p(","), _(), r.getToken() === 2 && b) break;
				} else w && y(6, [], []);
				T() || y(4, [], [2, 5]), w = !0;
			}
		...
		function D() {
			...
			for (; r.getToken() !== 4 && r.getToken() !== 17;) {
				...
				w ? (i.push(0), w = !1) : i[i.length - 1]++, M() || y(4, [], [4, 5]), R = !0;
			}
			return m(), w || i.pop(), r.getToken() !== 4 ? y(8, [4], []) : _(), !0;
		}
		function M() {
			switch (r.getToken()) {
				case 3: return D();
	...
	function Lt(e, t) {
		...
		if (Array.isArray(e)) {
			...
			for (n = 0; n < e.length; n++) if (!Lt(e[n], t[n])) return !1;
		} else {
			const i = [];
			for (r in e) i.push(r);
			i.sort();
			const s = [];
			for (r in t) s.push(r);
			if (s.sort(), !Lt(i, s)) return !1;
			for (n = 0; n < i.length; n++) if (!Lt(e[i[n]], t[i[n]])) return !1;
		}
		return !0;
	}
	function oe(e) {
	...
	(function(e) {
		function t(r, i) {
			return r === Number.MAX_VALUE && (r = Mn.MAX_VALUE), i === Number.MAX_VALUE && (i = Mn.MAX_VALUE), {
				line: r,
				character: i
			};
		}
	...
	(function(e) {
		...
		function n(r) {
			const i = r;
			return x.objectLiteral(i) && q.is(i.range) && Dr.is(i.color);
		}
		e.is = n;
	})(ca || (ca = {}));
	var fa;
	...
	(function(e) {
		...
		function n(r) {
			let i = r;
			return x.defined(i) && Nt.is(i.location) && x.string(i.message);
		}
		e.is = n;
	})(Or || (Or = {}));
	var de;
	...
	(function(e) {
		...
		function n(r) {
			var i;
			let s = r;
			return x.defined(s) && q.is(s.range) && x.string(s.message) && (x.number(s.severity) || x.undefined(s.severity)) && (x.integer(s.code) || x.string(s.code) || x.undefined(s.code)) && (x.undefined(s.codeDescription) || x.string((i = s.codeDescription) === null || i === void 0 ? void 0 : i.href)) && (x.string(s.source) || x.undefined(s.source)) && (x.undefined(s.relatedInformation) || x.typedArray(s.relatedInformation, Or.is));
		}
		e.is = n;
	})($e || ($e = {}));
	var St;
	...
	(function(e) {
		...
		function i(s) {
			const a = s;
			return Pe.is(a) && ($r.is(a.annotationId) || At.is(a.annotationId));
		}
		e.is = i;
	})(da || (da = {}));
	var Br;
	(function(e) {
		...
		function n(r) {
			let i = r;
			return x.defined(i) && Hr.is(i.textDocument) && Array.isArray(i.edits);
		}
		e.is = n;
	})(Br || (Br = {}));
	var Ur;
	(function(e) {
		...
		function n(r) {
			let i = r;
			return i && i.kind === "create" && x.string(i.uri) && (i.options === void 0 || (i.options.overwrite === void 0 || x.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || x.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || At.is(i.annotationId));
		}
		e.is = n;
	})(Ur || (Ur = {}));
	var qr;
	(function(e) {
		...
		function n(r) {
			let i = r;
			return i && i.kind === "rename" && x.string(i.oldUri) && x.string(i.newUri) && (i.options === void 0 || (i.options.overwrite === void 0 || x.boolean(i.options.overwrite)) && (i.options.ignoreIfExists === void 0 || x.boolean(i.options.ignoreIfExists))) && (i.annotationId === void 0 || At.is(i.annotationId));
		}
		e.is = n;
	})(qr || (qr = {}));
	var jr;
	(function(e) {
		...
		function n(r) {
			let i = r;
			return i && i.kind === "delete" && x.string(i.uri) && (i.options === void 0 || (i.options.recursive === void 0 || x.boolean(i.options.recursive)) && (i.options.ignoreIfNotExists === void 0 || x.boolean(i.options.ignoreIfNotExists))) && (i.annotationId === void 0 || At.is(i.annotationId));
		}
		e.is = n;
	})(jr || (jr = {}));
	var Wr;
	(function(e) {
		function t(n) {
			let r = n;
			return r && (r.changes !== void 0 || r.documentChanges !== void 0) && (r.documentChanges === void 0 || r.documentChanges.every((i) => x.string(i.kind) ? Ur.is(i) || qr.is(i) || jr.is(i) : Br.is(i)));
		}
		e.is = t;
	})(Wr || (Wr = {}));
	var pa;
	...
	(function(e) {
		function t(n) {
			const r = n;
			return x.objectLiteral(n) && tt.is(r.kind) && x.string(r.value);
		}
		e.is = t;
	})(Ht || (Ht = {}));
	var pe;
	...
	(function(e) {
		function t(n) {
			let r = n;
			return !!r && x.objectLiteral(r) && (Ht.is(r.contents) || En.is(r.contents) || x.typedArray(r.contents, En.is)) && (n.range === void 0 || q.is(n.range));
		}
		e.is = t;
	})(Sa || (Sa = {}));
	var Aa;
	...
	(function(e) {
		...
		function n(r) {
			let i = r;
			return x.defined(i) && x.typedArray(i.diagnostics, $e.is) && (i.only === void 0 || x.typedArray(i.only, x.string)) && (i.triggerKind === void 0 || i.triggerKind === Tn.Invoked || i.triggerKind === Tn.Automatic);
		}
		e.is = n;
	})(Ia || (Ia = {}));
	var Fa;
	(function(e) {
		function t(r, i, s) {
			let a = { title: r }, l = !0;
			return typeof i == "string" ? (l = !1, a.kind = i) : St.is(i) ? a.command = i : a.edit = i, l && s !== void 0 && (a.kind = s), a;
		}
		e.create = t;
		function n(r) {
			let i = r;
			return i && x.string(i.title) && (i.diagnostics === void 0 || x.typedArray(i.diagnostics, $e.is)) && (i.kind === void 0 || x.string(i.kind)) && (i.edit !== void 0 || i.command !== void 0) && (i.command === void 0 || St.is(i.command)) && (i.isPreferred === void 0 || x.boolean(i.isPreferred)) && (i.edit === void 0 || Wr.is(i.edit));
		}
		e.is = n;
	})(Fa || (Fa = {}));
	var Va;
	(function(e) {
		...
		function n(r) {
			let i = r;
			return x.defined(i) && q.is(i.range) && (x.undefined(i.command) || St.is(i.command));
		}
		e.is = n;
	})(Va || (Va = {}));
	var Da;
	...
	(function(e) {
		...
		function n(r) {
			const i = r;
			return x.objectLiteral(i) && (i.tooltip === void 0 || x.string(i.tooltip) || Ht.is(i.tooltip)) && (i.location === void 0 || Nt.is(i.location)) && (i.command === void 0 || St.is(i.command));
		}
		e.is = n;
	})(Jr || (Jr = {}));
	var za;
	(function(e) {
		...
		function n(r) {
			const i = r;
			return x.objectLiteral(i) && Y.is(i.position) && (x.string(i.label) || x.typedArray(i.label, Jr.is)) && (i.kind === void 0 || Gr.is(i.kind)) && i.textEdits === void 0 || x.typedArray(i.textEdits, Pe.is) && (i.tooltip === void 0 || x.string(i.tooltip) || Ht.is(i.tooltip)) && (i.paddingLeft === void 0 || x.boolean(i.paddingLeft)) && (i.paddingRight === void 0 || x.boolean(i.paddingRight));
		}
		e.is = n;
	})(za || (za = {}));
	var Ga;
	...
	(function(e) {
		function t(n) {
			const r = n;
			return x.objectLiteral(r) && Vr.is(r.uri) && x.string(r.name);
		}
		e.is = t;
	})(Ka || (Ka = {}));
	var eo;
...
` && r++;
	...
	var to = class di {
		...
		update(t, n) {
			for (let r of t) if (di.isIncremental(r)) {
				const i = ro(r.range), s = this.offsetAt(i.start), a = this.offsetAt(i.end);
			...
			} else if (di.isFull(r)) this._content = r.text, this._lineOffsets = void 0;
			else throw new Error("Unknown change event received");
			this._version = n;
		}
		getLineOffsets() {
			return this._lineOffsets === void 0 && (this._lineOffsets = no(this._content, !0)), this._lineOffsets;
		}
		positionAt(t) {
	...
	(function(e) {
		function t(i, s, a, l) {
			return new to(i, s, a, l);
		}
		e.create = t;
		function n(i, s, a) {
			if (i instanceof to) return i.update(s, a), i;
			throw new Error("TextDocument.update: document must be created by TextDocument.create");
		}
		e.update = n;
		function r(i, s) {
			let a = i.getText(), l = Xr(s.map(i0), (h, f) => {
				let g = h.range.start.line - f.range.start.line;
				return g === 0 ? h.range.start.character - f.range.start.character : g;
			}), o = 0;
			const u = [];
	...
	var s0 = /{([^}]+)}/g;
	function a0(e, t) {
		return Object.keys(t).length === 0 ? e : e.replace(s0, (n, r) => t[r] ?? n);
	}
	const o0 = {
		"color-hex": {
	...
	var ao = class {
		...
		include(t) {
			return (this.focusOffset === -1 || oo(t, this.focusOffset)) && t !== this.exclude;
		}
		newSub() {
	...
	var le = class {
		...
		mergeEnumValues(e) {
			if (!this.enumValueMatch && !e.enumValueMatch && this.enumValues && e.enumValues) {
				...
				for (const t of this.problems) t.code === z.EnumValueMismatch && (t.message = E("Value is not accepted. Valid values: {0}.", this.enumValues.map((n) => JSON.stringify(n)).join(", ")));
			}
		}
	...
	var lo = class {
		...
		getNodeFromOffset(e, t = !1) {
			if (this.root) return Yc(this.root, e, t);
		}
		visit(e) {
			if (this.root) {
				const t = (n) => {
		...
		validate(e, t, n = de.Warning, r) {
			if (this.root && t) {
				const i = new le();
				return se(this.root, t, i, zt.instance, new ao(r ?? uo(t))), i.problems.map((s) => {
					const a = q.create(e.positionAt(s.location.offset), e.positionAt(s.location.offset + s.location.length));
					return $e.create(a, s.message, s.severity ?? n, s.code);
				});
			}
		}
		getMatchingSchemas(e, t = -1, n) {
			if (this.root && e) {
				const r = new g0(t, n), i = new ao(uo(e));
				return se(this.root, e, new le(), r, i), r.schemas;
			}
			return [];
		}
	};
	function uo(e, t = ke.v2020_12) {
		let n = e.$schema;
		return n ? m0[n] ?? t : t;
	}
	function se(e, t, n, r, i) {
		...
		function a() {
			...
			if (Array.isArray(t.type) ? t.type.some(f) || n.problems.push({
				...
				se(s, be(N), b, _, i), n.merge(b), r.merge(_);
			}
			const g = be(t.not);
			if (g) {
			...
			const m = (N, b) => {
				...
				let y;
				for (const A of N) {
					const L = be(A), T = new le(), I = r.newSub();
					if (se(s, L, T, I, i), T.hasProblems() || _.push(L), !y) y = {
						schema: L,
						validationResult: T,
						matchingSchemas: I
					};
			...
			const d = (N) => {
				...
				const y = be(N), A = new le(), L = r.newSub();
				se(s, y, A, L, i), r.merge(L), n.mergeProcessedProperties(A), A.hasProblems() ? _ && d(_) : b && d(b);
			}, v = be(t.if);
			if (v && p(v, be(t.then), be(t.else)), Array.isArray(t.enum)) {
				const N = rt(s);
				let b = !1;
				for (const _ of t.enum) if (Lt(N, _)) {
					b = !0;
					break;
				}
			...
			Se(t.const) && (Lt(rt(s), t.const) ? n.enumValueMatch = !0 : (n.problems.push({
				location: {
					offset: s.offset,
					length: s.length
				},
		...
		function l(f) {
			...
			if (oe(t.multipleOf)) {
				...
				if (Number.isInteger(t.multipleOf)) _ = g % t.multipleOf;
					...
					if (y && A) {
						const L = 10 ** Math.abs(A.multiplier - y.multiplier);
						A.multiplier < y.multiplier ? A.value *= L : y.value *= L, _ = A.value % y.value;
					}
				}
				_ !== 0 && n.problems.push({
					location: {
		...
		function o(f) {
			if (oe(t.minLength) && aa(f.value) < t.minLength && n.problems.push({
				location: {
					offset: f.offset,
					length: f.length
				},
				message: E("String is shorter than the minimum length of {0}.", t.minLength)
			}), oe(t.maxLength) && aa(f.value) > t.maxLength && n.problems.push({
				location: {
					offset: f.offset,
					length: f.length
				},
				message: E("String is longer than the maximum length of {0}.", t.maxLength)
			}), sa(t.pattern) && (Rn(t.pattern)?.test(f.value) || n.problems.push({
				location: {
					offset: f.offset,
					length: f.length
				},
		...
		function u(f) {
			...
			if (g !== void 0) {
				...
				for (; d < N; d++) {
					...
					A && (se(A, _, y, r, i), n.mergePropertyMatch(y)), n.processedProperties.add(String(d));
				}
			}
			...
			if (p) {
				...
				for (let b = 0; b < f.items.length; b++) {
					...
					se(_, p, y, zt.instance, i), y.hasProblems() || (N++, i.schemaDraft >= ke.v2020_12 && n.processedProperties.add(String(b)));
				}
			...
			if (oe(t.minItems) && f.items.length < t.minItems && n.problems.push({
				...
				let b = function() {
					for (let _ = 0; _ < N.length - 1; _++) {
						const y = N[_];
						for (let A = _ + 1; A < N.length; A++) if (Lt(y, N[A])) return !0;
					}
					return !1;
				};
				const N = rt(f);
		...
		function h(f) {
			...
			if (t.properties) for (const b of Object.keys(t.properties)) {
				...
				if (y) if (Te(_)) if (_) n.propertiesMatches++, n.propertiesValueMatches++;
				else {
					const A = y.parent;
					n.problems.push({
						location: {
					...
					const A = new le();
					se(y, _, A, r, i), n.mergePropertyMatch(A);
				}
			}
				...
				if (_) {
					...
					for (const A of m) if (_.test(A)) {
						...
						if (L) {
							...
							if (Te(T)) if (T) n.propertiesMatches++, n.propertiesValueMatches++;
							else {
								const I = L.parent;
								n.problems.push({
									location: {
								...
								const I = new le();
								se(L, T, I, r, i), n.mergePropertyMatch(I);
							}
						}
					}
					y.forEach(d);
			...
			if (p !== void 0) for (const b of m) {
				...
				if (_) {
					if (p === !1) {
						...
						const y = new le();
						se(_, p, y, r, i), n.mergePropertyMatch(y);
					}
				}
			}
	...
	function p0(e, t) {
		...
		function o(y, A, L, T, I = de.Error) {
			if (n.length === 0 || L !== r) {
				const D = q.create(e.positionAt(L), e.positionAt(T));
				n.push($e.create(D, y, I, A, e.languageId)), r = L;
			}
		}
		function u(y, A, L = void 0, T = [], I = []) {
			let D = s.getTokenOffset(), M = s.getTokenOffset() + s.getTokenLength();
			if (D === M && D > 0) {
				for (D--; D > 0 && /\s/.test(i.charAt(D));) D--;
				M = D + 1;
			}
			if (o(y, A, D, M), L && f(L, !1), T.length + I.length > 0) {
				let w = s.getToken();
				for (; w !== 17;) {
					if (T.indexOf(w) !== -1) {
						l();
						break;
					} else if (I.indexOf(w) !== -1) break;
					w = l();
				}
			}
			return L;
		...
		function h() {
			switch (s.getTokenError()) {
				case 4: return u(E("Invalid unicode sequence in string."), z.InvalidUnicode), !0;
				case 5: return u(E("Invalid escape character in string."), z.InvalidEscapeCharacter), !0;
				case 3: return u(E("Unexpected end of number."), z.UnexpectedEndOfNumber), !0;
				case 1: return u(E("Unexpected end of comment."), z.UnexpectedEndOfComment), !0;
				case 2: return u(E("Unexpected end of string."), z.UnexpectedEndOfString), !0;
				case 6: return u(E("Invalid characters in string. Control characters must be escaped."), z.InvalidCharacter), !0;
			}
			return !1;
		}
		function f(y, A) {
		...
		function g(y) {
			...
			const A = new u0(y, s.getTokenOffset());
			l();
			let L = !1;
			for (; s.getToken() !== 4 && s.getToken() !== 17;) {
				if (s.getToken() === 5) {
					L || u(E("Value expected"), z.ValueExpected);
					const I = s.getTokenOffset();
					if (l(), s.getToken() === 4) {
						L && o(E("Trailing comma"), z.TrailingComma, I, I + 1);
						continue;
					}
				} else L && u(E("Expected comma"), z.CommaExpected);
				const T = b(A);
				T ? A.items.push(T) : u(E("Value expected"), z.ValueExpected, void 0, [], [4, 5]), L = !0;
			}
			return s.getToken() !== 4 ? u(E("Expected comma or closing bracket"), z.CommaOrCloseBacketExpected, A) : f(A, !0);
		}
		const m = new Zr(void 0, 0, 0);
		function d(y, A) {
			const L = new f0(y, s.getTokenOffset(), m);
			let T = v(L);
			if (!T) if (s.getToken() === 16) {
				u(E("Property keys must be doublequoted"), z.PropertyKeysMustBeDoublequoted);
				const D = new Zr(L, s.getTokenOffset(), s.getTokenLength());
				D.value = s.getTokenValue(), T = D, l();
			} else return;
			if (L.keyNode = T, T.value !== "//") {
				const D = A[T.value];
				D ? (o(E("Duplicate object key"), z.DuplicateKey, L.keyNode.offset, L.keyNode.offset + L.keyNode.length, de.Warning), He(D) && o(E("Duplicate object key"), z.DuplicateKey, D.keyNode.offset, D.keyNode.offset + D.keyNode.length, de.Warning), A[T.value] = !0) : A[T.value] = L;
			}
			if (s.getToken() === 6) L.colonOffset = s.getTokenOffset(), l();
			else if (u(E("Colon expected"), z.ColonExpected), s.getToken() === 10 && e.positionAt(T.offset + T.length).line < e.positionAt(s.getTokenOffset()).line) return L.length = T.length, L;
			const I = b(L);
			return I ? (L.valueNode = I, L.length = I.offset + I.length - L.offset, L) : u(E("Value expected"), z.ValueExpected, L, [], [2, 5]);
		}
		function p(y) {
			if (s.getToken() !== 1) return;
			const A = new h0(y, s.getTokenOffset()), L = Object.create(null);
			l();
			let T = !1;
			for (; s.getToken() !== 2 && s.getToken() !== 17;) {
				if (s.getToken() === 5) {
					T || u(E("Property expected"), z.PropertyExpected);
					const D = s.getTokenOffset();
					if (l(), s.getToken() === 2) {
						T && o(E("Trailing comma"), z.TrailingComma, D, D + 1);
						continue;
					}
				} else T && u(E("Expected comma"), z.CommaExpected);
				const I = d(A, L);
				I ? A.properties.push(I) : u(E("Property expected"), z.PropertyExpected, void 0, [], [2, 5]), T = !0;
			}
			return s.getToken() !== 2 ? u(E("Expected comma or closing brace"), z.CommaOrCloseBraceExpected, A) : f(A, !0);
		}
		function v(y) {
			if (s.getToken() !== 10) return;
			const A = new Zr(y, s.getTokenOffset());
			return A.value = s.getTokenValue(), f(A, !0);
		}
		function S(y) {
			if (s.getToken() !== 11) return;
			const A = new c0(y, s.getTokenOffset());
			if (s.getTokenError() === 0) {
				const L = s.getTokenValue();
				try {
					const T = JSON.parse(L);
					if (!oe(T)) return u(E("Invalid number format."), z.Undefined, A);
					A.value = T;
				} catch {
					return u(E("Invalid number format."), z.Undefined, A);
				}
				A.isInteger = L.indexOf(".") === -1;
			}
			return f(A, !0);
		}
		function N(y) {
			switch (s.getToken()) {
				case 7: return f(new l0(y, s.getTokenOffset()), !0);
				case 8: return f(new io(y, !0, s.getTokenOffset()), !0);
				case 9: return f(new io(y, !1, s.getTokenOffset()), !0);
				default: return;
			}
		}
		function b(y) {
		...
		let _;
		return l() !== 17 && (_ = b(_), _ ? s.getToken() !== 17 && u(E("End of file expected."), z.Undefined) : u(E("Expected a JSON object, array or literal."), z.Undefined)), new lo(_, n, a);
	}
	function Kr(e, t, n) {
		if (e !== null && typeof e == "object") {
			...
			if (Array.isArray(e)) {
				...
				let i = `[
`;
				for (let s = 0; s < e.length; s++) i += r + Kr(e[s], r, n), s < e.length - 1 && (i += ","), i += `
`;
				return i += t + "]", i;
			} else {
...
`;
				for (let a = 0; a < i.length; a++) {
					const l = i[a];
					s += r + JSON.stringify(l) + ": " + Kr(e[l], r, n), a < i.length - 1 && (s += ","), s += `
`;
				}
				return s += t + "}", s;
			}
	...
	var b0 = class {
			...
			return this.schemaService.getSchemaForResource(e.uri, n).then((f) => {
				...
				if (a && a.type === "object") {
					...
					a.properties.forEach((b) => {
						(!p || p !== b) && u.set(b.keyNode.value, zr.create("__"));
					});
					let S = "";
					...
					this.contributions.forEach((b) => {
						const _ = b.collectPropertyCompletions(e.uri, N, l, m, S === "", h);
						_ && g.push(_);
				...
				if (a.node === n && !a.inverted) {
					...
					l && Object.keys(l).forEach((u) => {
						...
						if (typeof h == "object" && !h.deprecationMessage && !h.doNotSuggest) {
							...
							h.suggestSortText !== void 0 && (f.sortText = h.suggestSortText), f.insertText && jt(f.insertText, `$1${i}`) && (f.command = {
								title: "Suggest",
					...
					if (typeof o == "object" && !o.deprecationMessage && !o.doNotSuggest) {
						const u = (h, f = void 0) => {
							...
							o.suggestSortText !== void 0 && (g.sortText = o.suggestSortText), g.insertText && jt(g.insertText, `$1${i}`) && (g.command = {
								title: "Suggest",
								command: "editor.action.triggerSuggest"
							}), s.add(g);
						};
		...
		getSchemaLessValueCompletions(e, t, n, r, i) {
			...
			const a = this.evaluateSeparatorAfter(r, s), l = (o) => {
				o.parent && !oo(o.parent, n, !0) && i.add({
				...
				for (const g of f) if (g.node === n && !g.inverted && g.schema) {
					if (n.type === "array" && g.schema.items) {
						...
						if (g.schema.uniqueItems) {
							...
							n.children.forEach((p) => {
								p.type !== "array" && p.type !== "object" && d.add(this.getLabelForValue(rt(p)));
							}), m = {
								...s,
								add(p) {
					...
					if (o !== void 0) {
						...
						if (g.schema.patternProperties && !m) {
							for (const d of Object.keys(g.schema.patternProperties)) if (Rn(d)?.test(o)) {
								m = !0;
...
` + m) + g + t, o = o || u, h = u.replace(/[\n]/g, "");
		...
		getInsertTextForSnippetValue(e, t) {
			return Kr(e, "", (r) => typeof r == "string" && r[0] === "^" ? r.substr(1) : JSON.stringify(r)) + t;
		}
...
\r\v":{[,]}`.indexOf(r.charAt(n)) === -1;) n--;
		...
		doesSupportMarkdown() {
			if (!Se(this.supportsMarkdown)) {
				...
				this.supportsMarkdown = Array.isArray(e) && e.indexOf(tt.Markdown) !== -1;
			}
		...
		doHover(e, t, n) {
			...
			return this.schemaService.getSchemaForResource(e.uri, n).then((u) => {
				if (u && i) {
					...
					let f, g, m, d;
					h.every((v) => {
						if (v.node === i && !v.inverted && v.schema && (f = f || v.schema.title, g = g || v.schema.markdownDescription || ei(v.schema.description), v.schema.enum)) {
							const S = v.schema.enum.indexOf(rt(i));
							v.schema.markdownEnumDescriptions ? m = v.schema.markdownEnumDescriptions[S] : v.schema.enumDescriptions && (m = ei(v.schema.enumDescriptions[S])), m && (d = v.schema.enum[S], typeof d != "string" && (d = JSON.stringify(d)));
						}
						return !0;
					});
					let p = "";
					return f && (p = ei(f)), g && (p.length > 0 && (p += `
...
$3`).replace(/[\\`*_{}[\]()#+\-.!]/g, "\\$&");
	...
	var w0 = class {
		...
		doValidation(e, t, n, r) {
			...
			const i = [], s = {}, a = (o) => {
				...
				let u = n?.trailingCommas ? Cn(n.trailingCommas) : de.Error, h = n?.comments ? Cn(n.comments) : this.commentSeverity, f = n?.schemaValidation ? Cn(n.schemaValidation) : de.Warning, g = n?.schemaRequest ? Cn(n.schemaRequest) : de.Warning;
				if (o) {
					const m = (d, p) => {
						if (t.root && g) {
					...
					if (o.errors.length) m(o.errors[0], z.SchemaResolveError);
					else if (f) {
						for (const p of o.warnings) m(p, z.SchemaUnsupportedFeature);
						const d = t.validate(e, o.schema, f, n?.schemaDraft);
						d && d.forEach(a);
					}
					co(o.schema) && (h = void 0), fo(o.schema) && (u = void 0);
				}
				for (const m of t.syntaxErrors) {
					if (m.code === z.TrailingComma) {
				...
				if (typeof h == "number") {
					...
					t.comments.forEach((d) => {
						a($e.create(d, m, h, z.CommentNotPermitted));
					});
				}
				return i;
			};
			if (r) {
				const o = r.id || "schemaservice://untitled/" + _0++;
	...
	const ho = 48, L0 = 57, N0 = 65, In = 97, S0 = 102;
	function ee(e) {
		return e < ho ? 0 : e <= L0 ? e - ho : (e < In && (e += In - N0), e >= In && e <= S0 ? e - In + 10 : 0);
	}
	function A0(e) {
	...
	var k0 = class {
		...
		findDocumentSymbols(e, t, n = { resultLimit: Number.MAX_VALUE }) {
			...
			const s = e.uri;
			if ((s === "vscode://defaultsettings/keybindings.json" || jt(s.toLowerCase(), "/user/keybindings.json")) && r.type === "array") {
				const f = [];
				for (const g of r.items) if (g.type === "object") {
					for (const m of g.properties) if (m.keyNode.value === "key" && m.valueNode) {
						const d = Nt.create(e.uri, ze(e, g));
						if (f.push({
							name: mo(m.valueNode),
							kind: Ce.Function,
							location: d
			...
			const u = [], h = (f, g) => {
				f.type === "array" ? f.items.forEach((m) => {
					...
					if (d) if (i > 0) {
						i--;
						const p = Nt.create(e.uri, ze(e, m)), v = g ? g + "." + m.keyNode.value : m.keyNode.value;
						u.push({
		...
		findDocumentSymbols2(e, t, n = { resultLimit: Number.MAX_VALUE }) {
			...
			if ((s === "vscode://defaultsettings/keybindings.json" || jt(s.toLowerCase(), "/user/keybindings.json")) && r.type === "array") {
				...
				for (const g of r.items) if (g.type === "object") {
					for (const m of g.properties) if (m.keyNode.value === "key" && m.valueNode) {
						const d = ze(e, g), p = ze(e, m.keyNode);
						if (f.push({
							name: mo(m.valueNode),
							kind: Ce.Function,
							range: d,
			...
			const h = (f, g) => {
				f.type === "array" ? f.items.forEach((m, d) => {
					...
					if (d) if (i > 0) {
						i--;
						const p = ze(e, m), v = ze(e, m.keyNode), S = [], N = {
							name: this.getKeyLabel(m),
							kind: this.getSymbolKind(d.type),
							range: p,
							selectionRange: v,
	...
	for (const e in ti.schemas) {
		const t = ti.schemas[e];
	...
	(() => {
		...
		(() => {
			...
			const s = /^\w[\w\d+.-]*$/, a = /^\//, l = /^\/\//;
			function o(M, w) {
				if (!M.scheme && w) throw new Error(`[UriError]: Scheme is missing: {scheme: "", authority: "${M.authority}", path: "${M.path}", query: "${M.query}", fragment: "${M.fragment}"}`);
			...
			class g {
				static isUri(w) {
					return w instanceof g || !!w && typeof w.authority == "string" && typeof w.fragment == "string" && typeof w.path == "string" && typeof w.query == "string" && typeof w.scheme == "string" && typeof w.fsPath == "string" && typeof w.with == "function" && typeof w.toString == "function";
				}
				constructor(w, R, P, C, F, V = !1) {
					it(this, "scheme", void 0), it(this, "authority", void 0), it(this, "path", void 0), it(this, "query", void 0), it(this, "fragment", void 0), typeof w == "object" ? (this.scheme = w.scheme || u, this.authority = w.authority || u, this.path = w.path || u, this.query = w.query || u, this.fragment = w.fragment || u) : (this.scheme = (function(j, G) {
						return j || G ? j : "file";
					})(w, V), this.authority = R || u, this.path = (function(j, G) {
						switch (j) {
							case "https":
							case "http":
				...
				with(w) {
					if (!w) return this;
					let { scheme: R, authority: P, path: C, query: F, fragment: V } = w;
				...
				static file(w) {
					...
					if (i && (w = w.replace(/\\/g, h)), w[0] === h && w[1] === h) {
						const P = w.indexOf(h, 2);
						P === -1 ? (R = w.substring(2), w = h) : (R = w.substring(2, P), w = w.substring(P) || h);
					}
					return new d("file", R, w, u, u);
				}
				static from(w) {
					const R = new d(w.scheme, w.authority, w.path, w.query, w.fragment);
					return o(R, !0), R;
				}
				toString(w = !1) {
					return b(this, w);
				...
				static revive(w) {
					if (w) {
						...
						{
							const R = new d(w);
							return R._formatted = w.external, R._fsPath = w._sep === m ? w.fsPath : null, R;
						}
					}
					return w;
				}
			...
			class d extends g {
				constructor(...w) {
					super(...w), it(this, "_formatted", null), it(this, "_fsPath", null);
				}
				get fsPath() {
				...
				toJSON() {
					const w = { $mid: 1 };
					return this._fsPath && (w.fsPath = this._fsPath, w._sep = m), this._formatted && (w.external = this._formatted), this.path && (w.path = this.path), this.scheme && (w.scheme = this.scheme), this.authority && (w.authority = this.authority), this.query && (w.query = this.query), this.fragment && (w.fragment = this.fragment), w;
				}
			}
			const p = {
				58: "%3A",
			...
			function v(M, w, R) {
				...
				for (let F = 0; F < M.length; F++) {
					...
					if (V >= 97 && V <= 122 || V >= 65 && V <= 90 || V >= 48 && V <= 57 || V === 45 || V === 46 || V === 95 || V === 126 || w && V === 47 || R && V === 91 || R && V === 93 || R && V === 58) C !== -1 && (P += encodeURIComponent(M.substring(C, F)), C = -1), P !== void 0 && (P += M.charAt(F));
					else {
			...
			function S(M) {
				...
				for (let R = 0; R < M.length; R++) {
					...
					P === 35 || P === 63 ? (w === void 0 && (w = M.substr(0, R)), w += p[P]) : w !== void 0 && (w += M[R]);
				}
				return w !== void 0 ? w : M;
			}
			function N(M, w) {
			...
			function b(M, w) {
				...
				if (C && (P += C, P += ":"), (F || C === "file") && (P += h, P += h), F) {
					let W = F.indexOf("@");
					if (W !== -1) {
						const _e = F.substr(0, W);
						F = F.substr(W + 1), W = _e.lastIndexOf(":"), W === -1 ? P += R(_e, !1, !1) : (P += R(_e.substr(0, W), !1, !1), P += ":", P += R(_e.substr(W + 1), !1, !0)), P += "@";
					}
				...
				return j && (P += "?", P += R(j, !1, !1)), G && (P += "#", P += w ? G : v(G, !1, !1)), P;
			}
			function _(M) {
				try {
			...
			function A(M) {
				return M.match(y) ? M.replace(y, ((w) => _(w))) : M;
			}
			var L = n(470);
			const T = L.posix || L, I = "/";
			var D;
			(function(M) {
				M.joinPath = function(w, ...R) {
					return w.with({ path: T.join(w.path, ...R) });
				}, M.resolvePath = function(w, ...R) {
					let P = w.path, C = !1;
					P[0] !== I && (P = I + P, C = !0);
					let F = T.resolve(P, ...R);
					return C && F[0] === I && !w.authority && (F = F.substring(1)), w.with({ path: F });
				}, M.dirname = function(w) {
					if (w.path.length === 0 || w.path === I) return w;
					let R = T.dirname(w.path);
					return R.length === 1 && R.charCodeAt(0) === 46 && (R = ""), w.with({ path: R });
				}, M.basename = function(w) {
					return T.basename(w.path);
				}, M.extname = function(w) {
					return T.extname(w.path);
				};
			})(D || (D = {}));
		})(), go = r;
	})();
	const { URI: kt, Utils: _2 } = go;
	function E0(e, t) {
	...
	var C0 = class {
		constructor(e, t, n) {
			...
			try {
				for (let r of e) {
					const i = r[0] !== T0;
					i || (r = r.substring(1)), r.length > 0 && (r[0] === P0 && (r = r.substring(1)), this.globWrappers.push({
						regexp: E0("**/" + r, {
							extended: !0,
							globstar: !0
						}),
				...
				t && (t = bo(t), t.endsWith("/") || (t = t + "/"), this.folderUri = t);
			} catch {
		...
		constructor(e, t, n) {
			this.service = e, this.uri = t, this.dependencies = /* @__PURE__ */ new Set(), this.anchors = void 0, n && (this.unresolvedSchema = this.service.promise.resolve(new Jt(n)));
		}
		getUnresolvedSchema() {
		...
		getSectionRecursive(e, t) {
			...
			if (t.patternProperties) {
				for (const r of Object.keys(t.patternProperties)) if (Rn(r)?.test(n)) return this.getSectionRecursive(e, t.patternProperties[r]);
			} else {
		...
		setSchemaContributions(e) {
			...
			if (Array.isArray(e.schemaAssociations)) {
				...
				for (let n of t) {
					const r = n.uris.map(Ge), i = this.addFilePatternAssociation(n.pattern, n.folderUri, r);
					this.contributionAssociations.push(i);
				}
			}
		}
		addSchemaHandle(e, t) {
			const n = new I0(this, e, t);
		...
		getResolvedSchema(e) {
			const t = Ge(e), n = this.schemasById[t];
			return n ? n.getResolvedSchema() : this.promise.resolve(void 0);
		}
		loadSchema(e) {
			if (!this.requestService) {
				const t = E("Unable to load schema from '{0}'. No schema request service available", Xt(e));
				return this.promise.resolve(new Jt({}, [t]));
			}
			return e.startsWith("http://json-schema.org/") && (e = "https" + e.substring(4)), this.requestService(e).then((t) => {
				if (!t) return new Jt({}, [E("Unable to load schema from '{0}': No content.", Xt(e))]);
				const n = [];
				t.charCodeAt(0) === 65279 && (n.push(E("Problem reading content from '{0}': UTF-8 with BOM detected, only UTF 8 is allowed.", Xt(e))), t = t.trimStart());
				let r = {};
				const i = [];
				return r = Zc(t, i), i.length && n.push(E("Unable to parse content from '{0}': Parse error at offset {1}.", Xt(e), i[0].offset)), new Jt(r, n);
			}, (t) => {
				let n = t.toString();
				const r = t.toString().split("Error: ");
				return r.length > 1 && (n = r[1]), jt(n, ".") && (n = n.substr(0, n.length - 1)), new Jt({}, [E("Unable to load schema from '{0}': {1}.", Xt(e), n)]);
			});
		}
		resolveSchemaContent(e, t) {
			const n = e.errors.slice(0), r = e.schema;
			let i = r.$schema ? Ge(r.$schema) : void 0;
			if (i === "http://json-schema.org/draft-03/schema") return this.promise.resolve(new po({}, [E("Draft-03 schemas are not supported.")], [], i));
			...
			const a = this.contextService, l = (d, p) => {
				...
				a && !/^[A-Za-z][A-Za-z0-9+\-.+]*:\/\/.*/.test(p) && (p = a.resolveRelativePath(p, S.uri)), p = Ge(p);
				...
				return this.traverseNodes(d, (v) => {
					const S = v.$id || v.id, N = sa(S) && S.charAt(0) === "#" ? S.substring(1) : v.$anchor;
			...
			return g(r, r, t).then((d) => {
				let p = [];
				return s.size && p.push(E("The schema uses meta-schema features ({0}) that are not yet supported by the validator.", Array.from(s.keys()).join(", "))), new po(r, n, p, i);
			});
		}
		traverseNodes(e, t) {
		...
		getAssociatedSchemas(e) {
			const t = Object.create(null), n = [], r = bo(e);
		...
		getMatchingSchemas(e, t, n) {
			if (n) {
				const r = n.id || "schemaservice://untitled/matchingSchemas/" + V0++;
	...
	function O0(e, t, n) {
		function r(l) {
			...
			return f || (f = Pn.create(q.create(l, l))), f;
		}
		function i(l, o) {
...
`,
		...
		return t0(e.getText(), r, i).map((s) => Pe.replace(q.create(e.positionAt(s.offset), e.positionAt(s.offset + s.length)), s.content));
	}
	var re;
	(function(e) {
	...
	var Fn = class {
		...
		addChildProperty(e) {
			if (e.parent = this, this.childrenProperties.length > 0) {
				let t = 0;
				e.noKeyName ? t = this.childrenProperties.length : t = B0(this.childrenProperties, e, $0), t < 0 && (t = t * -1 - 1), this.childrenProperties.splice(t, 0, e);
	...
	function U0(e, t) {
		const n = {
			...t,
			keepLines: !1
		}, r = Ae.applyEdits(e, ni(e, n, void 0)), i = Ae.create("test://test.json", "json", 0, r), s = j0(i, q0(i)), a = ni(s, n, void 0), l = Ae.applyEdits(s, a);
		return [Pe.replace(q.create(Y.create(0, 0), e.positionAt(e.getText().length)), l)];
	}
	function q0(e) {
		const t = et(e.getText(), !1);
		let n = new Fn(), r = n, i = n, s = n, a, l = 0, o = 0, u, h, f = -1, g = -1, m = 0, d = 0, p = [], v = !1, S = !1;
		for (; (a = t.scan()) !== 17;) {
			...
			switch (a) {
				case 10:
					if (u === void 0 || u === 1 || u === 5 && p[p.length - 1] === re.Object) {
						const N = new Fn(t.getTokenValue(), m);
				...
				case 2:
					...
					break;
				case 5:
					d = t.getTokenStartLine(), i.endLineNumber === void 0 && (p[p.length - 1] === re.Object || p[p.length - 1] === re.Array && (u === 2 || u === 4)) && (i.endLineNumber = d, i.commaIndex = t.getTokenOffset() - o, i.commaLine = d), (u === 2 || u === 4) && (s = i, i = i ? i.parent : void 0, r = i), m = d + 1;
					break;
				case 13:
					u === 5 && f === t.getTokenStartLine() && (p[p.length - 1] === re.Array && (h === 2 || h === 4) || p[p.length - 1] === re.Object) && (p[p.length - 1] === re.Array && (h === 2 || h === 4) || p[p.length - 1] === re.Object) && (i.endLineNumber = void 0, v = !0), (u === 1 || u === 3) && f === t.getTokenStartLine() && (S = !0);
					break;
			}
	...
	function j0(e, t) {
		...
		for (yo(r, t, t.beginningLineNumber); r.length > 0;) {
			...
			for (let l = 0; l < s.length; l++) {
				...
				Ae.update(n, [m], 1), yo(r, o, a), a = a + g;
			}
		}
		return n;
	}
	...
	function vo(e, t, n) {
		for (const r of t.childrenProperties) {
			...
			r.type === re.Array && vo(e, r, n + r.beginningLineNumber - t.beginningLineNumber);
		}
	}
	var wo = class {
		constructor(e, t) {
	...
	function ri(e, t) {
		...
		if (t && t.type === "object") {
			...
			return r ? ri(e, r.valueNode) : null;
		} else if (t && t.type === "array" && n.match(/^(0|[1-9][0-9]*)$/)) {
			const r = Number.parseInt(n), i = t.items[r];
			return i ? ri(e, i) : null;
		}
		return null;
	}
	function G0(e) {
		return e === "#" ? [] : e[0] !== "#" || e[1] !== "/" ? null : e.substring(2).split(/\//).map(J0);
	}
	function J0(e) {
		return e.replace(/~1/g, "/").replace(/~0/g, "~");
	}
	function X0(e) {
		const t = e.promiseConstructor || Promise, n = new F0(e.schemaRequestService, e.workspaceContext, t);
		n.setSchemaContributions(ti);
		const r = new b0(n, e.contributions, t, e.clientCapabilities), i = new y0(n, e.contributions, t), s = new k0(n), a = new w0(n, t);
		return {
			configure: (l) => {
			...
			parseJSONDocument: (l) => p0(l, { collectComments: !0 }),
			newJSONDocument: (l, o) => d0(l, o),
			...
			findLinks: W0,
			format: (l, o, u) => ni(l, u, o),
			sort: (l, o) => U0(l, o)
		};
	}
	let _o;
	typeof fetch < "u" && (_o = function(e) {
		return fetch(e).then((t) => t.text());
	});
	var Q0 = class {
		constructor(e, t) {
			this._ctx = e, this._languageSettings = t.languageSettings, this._languageId = t.languageId, this._languageService = X0({
				workspaceContext: { resolveRelativePath: (n, r) => K0(r.substr(0, r.lastIndexOf("/") + 1), n) },
				schemaRequestService: t.enableSchemaRequest ? _o : void 0,
	...
	function Lo(e) {
		const t = [];
		for (const r of e) r.length === 0 || r.length === 1 && r.charCodeAt(0) === ii || (r.length === 2 && r.charCodeAt(0) === ii && r.charCodeAt(1) === ii ? t.pop() : t.push(r));
